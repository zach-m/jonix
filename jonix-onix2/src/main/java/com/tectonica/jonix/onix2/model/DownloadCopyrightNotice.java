...
public class DownloadCopyrightNotice
{
	...
	public static DownloadCopyrightNotice fromDoc(org.w3c.dom.Element element)
	{
		final DownloadCopyrightNotice x = new DownloadCopyrightNotice();
