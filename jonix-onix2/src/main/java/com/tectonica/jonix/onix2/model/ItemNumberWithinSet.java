...
public class ItemNumberWithinSet
{
	...
	public static ItemNumberWithinSet fromDoc(org.w3c.dom.Element element)
	{
		final ItemNumberWithinSet x = new ItemNumberWithinSet();
