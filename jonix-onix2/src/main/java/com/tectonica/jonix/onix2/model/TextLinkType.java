...
import com.tectonica.jonix.onix2.codelist.List35;
...
public class TextLinkType
{
	...
	public static TextLinkType fromDoc(org.w3c.dom.Element element)
	{
		final TextLinkType x = new TextLinkType();
		...
		x.value = List35.byValue(DU.getContentAsString(element));
