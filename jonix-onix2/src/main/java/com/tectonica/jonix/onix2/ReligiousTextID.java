 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ReligiousText} ⯈ {@link ReligiousTextID}</li>
 * </ul>
 *
 * @since Onix-2.1
 */
public class ReligiousTextID implements OnixElement<String>, Serializable {
    ...
    public static final String refname = "ReligiousTextID";
    ...
    public static final ReligiousTextID EMPTY = new ReligiousTextID();

    public ReligiousTextID() {
        exists = false;
    }

    public ReligiousTextID(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<ReligiousTextID> action) {
        if (exists) {
            action.accept(this);
        }
    }
