 ...
 * cellpadding='3'><tr><td>Reference name</td><td><tt>&lt;RelatedProduct&gt;</tt></td></tr><tr><td>Short
 * tag</td><td><tt>&lt;relatedproduct&gt;</tt></td></tr></table>
 * <p>&nbsp;</p>
...
public class RelatedProduct implements OnixSuperComposite, Serializable {
    ...
    /**
     * <p>An ONIX code which identifies the nature of the relationship between two products, <em>eg</em> “replaced-by”.
     * Mandatory in each occurrence of the &lt;RelatedProduct&gt; composite, and non-repeating.</p>
    ...
    /**
     * <p>10-character ISBN of the related product. Optional and non-repeating. <strong>The &lt;ProductIdentifier&gt;
     * composite provides a more general method of handling identifiers, and is to be preferred. The &lt;ISBN&gt;
     * element is on no account to be used to carry a 13-digit ISBN.</strong></p>
     * Jonix-Comment: this field is required
     */
    public ISBN isbn() {
        _initialize();
    ...
    /**
     * <p>EAN.UCC-13 number of the related product. Optional and non-repeating. <strong>The &lt;ProductIdentifier&gt;
     * composite provides a more general method of handling identifiers, and is to be preferred.</strong></p>
     ...
     * section&nbsp;PR.2 for details of the handling of ISBN-13.</strong></p>
     ...
     * which is relevant to the product identified in an occurrence of the &lt;RelatedProduct&gt; composite.</p>
     * Jonix-Comment: this list may be empty
     */
    ...
    /**
     * <p>An ONIX code which indicates the primary form of the product. Optional and non-repeating; required in any
     * occurrence of the &lt;RelatedProduct&gt; composite that does not carry a product identifier.</p>
     * Jonix-Comment: this field is optional
     */
     ...
     * for purposes of upwards compatibility, and its use is now to be deprecated.</strong></p>
     * Jonix-Comment: this list may be empty
     */
    ...
    /**
     * <p>If product form codes do not adequately describe the product, a short text description may be added. The text
     * may include the number and type of pieces contained in a multiple product, and/or a more detailed specification
     * of the product form. The field is optional and non-repeating.</p>
     * Jonix-Comment: this field is optional
     */
     ...
     * &lt;ProductForm&gt; code for the product is DG.</p>
     * Jonix-Comment: this field is optional
     */
     ...
     * of a related product. The composite will allow additional publishing roles to be introduced without adding new
     * fields. Each occurrence of the composite must carry a publishing role code and either a name code or a name or
     * both. <strong>Please see Group&nbsp;PR.19 for details.</strong></p>
     * Jonix-Comment: this list may be empty
     */
