 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link OtherText} ⯈ {@link StartDate}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link OtherText} ⯈ {@link StartDate}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link OtherText} ⯈ {@link StartDate}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link OtherText} ⯈ {@link StartDate}</li>
 * </ul>
 *
 * @since Onix-2.1
 */
