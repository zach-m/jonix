...
public class PriceEffectiveUntil
{
	...
	public static PriceEffectiveUntil fromDoc(org.w3c.dom.Element element)
	{
		final PriceEffectiveUntil x = new PriceEffectiveUntil();
