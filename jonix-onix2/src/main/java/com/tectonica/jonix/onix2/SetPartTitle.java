 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link Set} ⯈ {@link SetPartTitle}</li>
 * </ul>
 */
public class SetPartTitle implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of SetPartTitle. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    /**
     * @return whether this tag (&lt;SetPartTitle&gt; or &lt;b025&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<SetPartTitle> action) {
        if (exists) {
            action.accept(this);
        }
    }
