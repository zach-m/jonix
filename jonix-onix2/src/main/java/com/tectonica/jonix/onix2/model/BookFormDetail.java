...
import com.tectonica.jonix.onix2.codelist.List8;
...
public class BookFormDetail
{
	...
	public static BookFormDetail fromDoc(org.w3c.dom.Element element)
	{
		final BookFormDetail x = new BookFormDetail();
		...
		x.value = List8.byValue(DU.getContentAsString(element));
