 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;SetPartNumber&gt;Part II&lt;/SetPartNumber&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link Set} ⯈ {@link SetPartNumber}</li>
 * </ul>
 */
public class SetPartNumber implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of SetPartNumber. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public void ifExists(Consumer<SetPartNumber> action) {
        if (exists) {
            action.accept(this);
        }
    }
