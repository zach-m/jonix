 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link TextItem} ⯈ {@link LastPageNumber}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link TextItem} ⯈ {@link PageRun} ⯈ {@link LastPageNumber}</li>
 * </ul>
 */
public class LastPageNumber implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<LastPageNumber> action) {
        if (exists) {
            action.accept(this);
        }
    }
