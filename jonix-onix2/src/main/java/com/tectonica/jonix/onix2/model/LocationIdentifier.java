...
public class LocationIdentifier
{
	...
	public LocationIDType locationIDType; // Required
	public IDTypeName idTypeName; // Optional
	public IDValue idValue; // Required

	public static LocationIdentifier fromDoc(org.w3c.dom.Element element)
	{
		final LocationIdentifier x = new LocationIdentifier();
		...
		DU.forElementsOf(element, new DU.ElementListener()
		{
			...
			public void onElement(org.w3c.dom.Element element)
			{
				...
				if (name.equalsIgnoreCase(LocationIDType.refname) || name.equalsIgnoreCase(LocationIDType.shortname))
					x.locationIDType = LocationIDType.fromDoc(element);
