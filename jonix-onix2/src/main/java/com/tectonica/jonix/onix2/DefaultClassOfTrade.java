...
public class DefaultClassOfTrade
{
	...
	public static DefaultClassOfTrade fromDoc(org.w3c.dom.Element element)
	{
		final DefaultClassOfTrade x = new DefaultClassOfTrade();
