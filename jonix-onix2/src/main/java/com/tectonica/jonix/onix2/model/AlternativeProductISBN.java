...
public class AlternativeProductISBN
{
	...
	public static AlternativeProductISBN fromDoc(org.w3c.dom.Element element)
	{
		final AlternativeProductISBN x = new AlternativeProductISBN();
