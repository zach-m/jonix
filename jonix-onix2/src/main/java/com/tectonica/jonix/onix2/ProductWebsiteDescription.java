 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ProductWebsite} ⯈ {@link ProductWebsiteDescription}</li>
 * </ul>
 */
public class ProductWebsiteDescription implements OnixElement<String>, Serializable {
    private static final long serialVersionUID = 1L;

    public static final String refname = "ProductWebsiteDescription";
    public static final String shortname = "f170";
    ...
    public static final ProductWebsiteDescription EMPTY = new ProductWebsiteDescription();

    public ProductWebsiteDescription() {
        exists = false;
    }

    public ProductWebsiteDescription(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<ProductWebsiteDescription> action) {
        if (exists) {
            action.accept(this);
        }
    }
