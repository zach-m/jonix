...
public class SalesRestrictionDetail
{
	...
	public static SalesRestrictionDetail fromDoc(org.w3c.dom.Element element)
	{
		final SalesRestrictionDetail x = new SalesRestrictionDetail();
