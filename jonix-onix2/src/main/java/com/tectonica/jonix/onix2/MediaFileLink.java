 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link MediaFile} ⯈ {@link MediaFileLink}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link MediaFile} ⯈ {@link MediaFileLink}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link MediaFile} ⯈ {@link MediaFileLink}</li>
 * </ul>
 */
public class MediaFileLink implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of MediaFileLink. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public void ifExists(Consumer<MediaFileLink> action) {
        if (exists) {
            action.accept(this);
        }
    }
