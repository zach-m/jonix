 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link EpubSourceVersion}</li>
 * </ul>
 */
public class EpubSourceVersion implements OnixElement<String>, Serializable {
    ...
    public static final EpubSourceVersion EMPTY = new EpubSourceVersion();

    public EpubSourceVersion() {
        exists = false;
    }

    public EpubSourceVersion(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<EpubSourceVersion> action) {
        if (exists) {
            action.accept(this);
        }
    }
