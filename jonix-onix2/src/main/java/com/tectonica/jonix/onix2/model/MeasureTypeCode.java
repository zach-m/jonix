...
import com.tectonica.jonix.onix2.codelist.List48;
...
public class MeasureTypeCode
{
	...
	public static MeasureTypeCode fromDoc(org.w3c.dom.Element element)
	{
		final MeasureTypeCode x = new MeasureTypeCode();
		...
		x.value = List48.byValue(DU.getContentAsString(element));
