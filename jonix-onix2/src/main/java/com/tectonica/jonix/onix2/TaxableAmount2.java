 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Price} ⯈ {@link TaxableAmount2}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link Price} ⯈ {@link TaxableAmount2}</li>
 * </ul>
 */
public class TaxableAmount2 implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of TaxableAmount2. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public void ifExists(Consumer<TaxableAmount2> action) {
        if (exists) {
            action.accept(this);
        }
    }
