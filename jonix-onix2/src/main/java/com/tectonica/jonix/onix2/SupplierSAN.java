 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link SupplierSAN}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link NewSupplier} ⯈ {@link SupplierSAN}</li>
 * </ul>
 */
public class SupplierSAN implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of SupplierSAN. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    /**
     * @return whether this tag (&lt;SupplierSAN&gt; or &lt;j136&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<SupplierSAN> action) {
        if (exists) {
            action.accept(this);
        }
    }
