 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link MediaFile} ⯈ {@link DownloadCopyrightNotice}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link MediaFile} ⯈ {@link DownloadCopyrightNotice}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link MediaFile} ⯈
...
public class DownloadCopyrightNotice implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<DownloadCopyrightNotice> action) {
        if (exists) {
            action.accept(this);
        }
    }
