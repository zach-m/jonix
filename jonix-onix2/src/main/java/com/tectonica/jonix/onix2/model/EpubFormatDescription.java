...
public class EpubFormatDescription
{
	...
	public static EpubFormatDescription fromDoc(org.w3c.dom.Element element)
	{
		final EpubFormatDescription x = new EpubFormatDescription();
