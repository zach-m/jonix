...
import com.tectonica.jonix.onix2.codelist.List51;
...
public class RelationCode
{
	...
	public static RelationCode fromDoc(org.w3c.dom.Element element)
	{
		final RelationCode x = new RelationCode();
		...
		x.value = List51.byValue(DU.getContentAsString(element));
