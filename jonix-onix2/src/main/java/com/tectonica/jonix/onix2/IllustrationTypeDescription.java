 ...
 * text, suggested maximum length 100 characters.</td></tr><tr><td>Reference name</td><td>&lt;IllustrationTypeDescription&gt;</td></tr><tr><td>Short
 * tag</td><td>&lt;b361&gt;</td></tr><tr><td>Example</td><td>&#160;</td></tr></table>
 */
public class IllustrationTypeDescription implements OnixElement<String>, Serializable {
    private static final long serialVersionUID = 1L;

    public static final String refname = "IllustrationTypeDescription";
    public static final String shortname = "b361";
    ...
    public static final IllustrationTypeDescription EMPTY = new IllustrationTypeDescription();

    public IllustrationTypeDescription() {
        exists = false;
    }

    public IllustrationTypeDescription(org.w3c.dom.Element element) {
        exists = true;
