 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;SetItemTitle&gt;After
 * Rome&lt;/SetItemTitle&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link ONIXMessage} ⯈ {@link Product} ⯈ {@link Set} ⯈ {@link SetItemTitle}</li>
 * </ul>
 */
public class SetItemTitle implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of SetItemTitle. Could be null if {@code exists == false}. Use {@link #value()} instead
    ...
    public static final SetItemTitle EMPTY = new SetItemTitle();
    ...
    /**
     * @return whether this tag (&lt;SetItemTitle&gt; or &lt;b281&gt;) is explicitly provided in the ONIX XML
     */
    @Override
