...
public class MarketCountryExcluded
{
	...
	public static MarketCountryExcluded fromDoc(org.w3c.dom.Element element)
	{
		final MarketCountryExcluded x = new MarketCountryExcluded();
