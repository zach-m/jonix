...
/**
 * <h1>Other alternative product EAN-13</h1><p>EAN-13 article number identifying another product which is available and
 * which the publisher suggests as an alternative. This element is used when the suggested alternative is neither a
...
public class AlternativeProductEAN13 implements OnixElement<String>, Serializable {
    ...
    public static final AlternativeProductEAN13 EMPTY = new AlternativeProductEAN13();

    public AlternativeProductEAN13() {
        exists = false;
    }

    public AlternativeProductEAN13(org.w3c.dom.Element element) {
        exists = true;
