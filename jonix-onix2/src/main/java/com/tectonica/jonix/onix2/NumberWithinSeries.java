 ...
 * <li>{@link Product} ⯈ {@link Series} ⯈ {@link NumberWithinSeries}</li>
 * </ul>
 */
public class NumberWithinSeries implements OnixElement<String>, Serializable {
    private static final long serialVersionUID = 1L;

    public static final String refname = "NumberWithinSeries";
    public static final String shortname = "b019";
    ...
    public static final NumberWithinSeries EMPTY = new NumberWithinSeries();

    public NumberWithinSeries() {
        exists = false;
    }

    public NumberWithinSeries(org.w3c.dom.Element element) {
        exists = true;
    ...
    /**
     * @return whether this tag (&lt;NumberWithinSeries&gt; or &lt;b019&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<NumberWithinSeries> action) {
        if (exists) {
            action.accept(this);
        }
    }
