 ...
 * <p>
 * Free text used to give details of the reprint history as part of the promotion of a book. Optional, and repeatable to
 * give information about successive reprintings.
 * </p>
 ...
 * <ul>
 * <li>{@link ONIXMessage} ⯈ {@link Product} ⯈ {@link ReprintDetail}</li>
 * </ul>
 *
 * @since Onix-2.13
 */
public class ReprintDetail implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of ReprintDetail. Could be null if {@code exists == false}. Use {@link #value()} instead
