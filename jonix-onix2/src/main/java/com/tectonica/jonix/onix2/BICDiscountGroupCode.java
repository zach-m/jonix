...
public class BICDiscountGroupCode
{
	...
	public static BICDiscountGroupCode fromDoc(org.w3c.dom.Element element)
	{
		final BICDiscountGroupCode x = new BICDiscountGroupCode();
