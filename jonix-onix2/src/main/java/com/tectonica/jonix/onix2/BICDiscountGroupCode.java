 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Price} ⯈ {@link BICDiscountGroupCode}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link Price} ⯈ {@link BICDiscountGroupCode}</li>
 * </ul>
 */
public class BICDiscountGroupCode implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of BICDiscountGroupCode. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public void ifExists(Consumer<BICDiscountGroupCode> action) {
        if (exists) {
            action.accept(this);
        }
    }
