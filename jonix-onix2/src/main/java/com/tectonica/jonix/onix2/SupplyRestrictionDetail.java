...
public class SupplyRestrictionDetail
{
	...
	public static SupplyRestrictionDetail fromDoc(org.w3c.dom.Element element)
	{
		final SupplyRestrictionDetail x = new SupplyRestrictionDetail();
