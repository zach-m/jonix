...
public class AudienceRestrictionNote
{
	...
	public static AudienceRestrictionNote fromDoc(org.w3c.dom.Element element)
	{
		final AudienceRestrictionNote x = new AudienceRestrictionNote();
