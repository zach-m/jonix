...
import com.tectonica.jonix.onix2.codelist.List94;

/*
 * NOTE: THIS IS AN AUTO-GENERATED FILE, DON'T EDIT IT
 */

public class DefaultLinearUnit
{
	...
	public static DefaultLinearUnit fromDoc(org.w3c.dom.Element element)
	{
		final DefaultLinearUnit x = new DefaultLinearUnit();
		...
		x.value = List94.byValue(DU.getContentAsString(element));
