 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link TextItem} ⯈ {@link FirstPageNumber}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link TextItem} ⯈ {@link PageRun} ⯈ {@link FirstPageNumber}</li>
 * </ul>
 */
public class FirstPageNumber implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<FirstPageNumber> action) {
        if (exists) {
            action.accept(this);
        }
    }
