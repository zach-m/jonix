 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ConferenceDate}</li>
 * <li>{@link Product} ⯈ {@link Conference} ⯈ {@link ConferenceDate}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class ConferenceDate implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of ConferenceDate. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public void ifExists(Consumer<ConferenceDate> action) {
        if (exists) {
            action.accept(this);
        }
    }
