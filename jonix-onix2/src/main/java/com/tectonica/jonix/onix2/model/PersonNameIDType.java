...
import com.tectonica.jonix.onix2.codelist.List101;
...
public class PersonNameIDType
{
	...
	public List101 value;

	public static PersonNameIDType fromDoc(org.w3c.dom.Element element)
	{
		final PersonNameIDType x = new PersonNameIDType();
		...
		x.value = List101.byValue(DU.getContentAsString(element));
