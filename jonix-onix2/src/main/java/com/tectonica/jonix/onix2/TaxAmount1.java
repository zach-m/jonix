 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Price} ⯈ {@link TaxAmount1}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link Price} ⯈ {@link TaxAmount1}</li>
 * </ul>
 */
public class TaxAmount1 implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of TaxAmount1. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public void ifExists(Consumer<TaxAmount1> action) {
        if (exists) {
            action.accept(this);
        }
    }
