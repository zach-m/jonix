 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link Contributor} ⯈ {@link PersonDate} ⯈ {@link PersonDateRole}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link Contributor} ⯈ {@link PersonDate} ⯈ {@link PersonDateRole}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link Contributor} ⯈ {@link PersonDate} ⯈ {@link PersonDateRole}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link Contributor} ⯈ {@link PersonDate} ⯈ {@link PersonDateRole}</li>
 * <li>{@link Product} ⯈ {@link Series} ⯈ {@link Contributor} ⯈ {@link PersonDate} ⯈ {@link PersonDateRole}</li>
 * </ul>
 *
 * @since Onix-2.1
 */
public class PersonDateRole implements OnixElement<PersonDateRoles>, Serializable {
    ...
    public void ifExists(Consumer<PersonDateRole> action) {
        if (exists) {
            action.accept(this);
        }
    }
