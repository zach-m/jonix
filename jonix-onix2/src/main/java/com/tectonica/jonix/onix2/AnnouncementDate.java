 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link AnnouncementDate}</li>
 * </ul>
 */
public class AnnouncementDate implements OnixElement<String>, Serializable {
    private static final long serialVersionUID = 1L;

    public static final String refname = "AnnouncementDate";
    public static final String shortname = "b086";
    ...
    public static final AnnouncementDate EMPTY = new AnnouncementDate();

    public AnnouncementDate() {
        exists = false;
    }

    public AnnouncementDate(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<AnnouncementDate> action) {
        if (exists) {
            action.accept(this);
        }
    }
