 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;m175&gt;Jackie Brown, 020 7979 6444&lt;/m175&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link Header} ⯈ {@link FromPerson}</li>
 * </ul>
 */
public class FromPerson implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of FromPerson. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public void ifExists(Consumer<FromPerson> action) {
        if (exists) {
            action.accept(this);
        }
    }
