 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link EpubTypeNote}</li>
 * <li>{@link Product} ⯈ {@link RelatedProduct} ⯈ {@link EpubTypeNote}</li>
 * </ul>
 */
public class EpubTypeNote implements OnixElement<String>, Serializable {
    ...
    /**
     * @return whether this tag (&lt;EpubTypeNote&gt; or &lt;b277&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<EpubTypeNote> action) {
        if (exists) {
            action.accept(this);
        }
    }
