...
import com.tectonica.jonix.onix2.codelist.List33;
...
public class TextTypeCode
{
	...
	public static TextTypeCode fromDoc(org.w3c.dom.Element element)
	{
		final TextTypeCode x = new TextTypeCode();
		...
		x.value = List33.byValue(DU.getContentAsString(element));
