...
/**
 * <h1>Contributor composite</h1><p>A repeatable group of data elements which together describe a personal or corporate
 * contributor to the series. The composite is optional in any occurrence of the &lt;Series&gt; composite.
 * <strong>Please see Group&nbsp;PR.8 for details.</strong></p><table border='1' cellpadding='3'><tr><td>Reference
 * name</td><td><tt>&lt;Contributor&gt;</tt></td></tr><tr><td>Short tag</td><td><tt>&lt;contributor&gt;</tt></td></tr></table>
 * <p>&nbsp;</p>
...
public class Contributor implements OnixSuperComposite, Serializable {
    ...
    /**
     * <p>A number which specifies a single overall sequence of contributor names. Optional and non-repeating. There are
     ...
     * &lt;Contributor&gt; composite should carry an overall &lt;SequenceNumber&gt;.</p>
     ...
     * corporate body has more than one role in relation to the product. Note, however, that if the
     * &lt;SequenceNumberWithinRole&gt; element is used to establish individual sequences of contributor names by role,
     * the &lt;ContributorRole&gt; element must not be repeated. There must instead be separate occurrences of the
     * &lt;Contributor&gt; composite if the same person has two or more roles.</p>
     ...
     * the language from which the translation was made. This makes it possible to specify a translator’s exact
     * responsibility when a work involved translation from two or more languages. Optional and repeatable in the
     * unlikely event that a single person has been responsible for translation from two or more languages.</p>
    ...
    /**
     * <p>A number which specifies the sequence of contributor names within a specified role, for applications which
     * require this form of numbering. Optional and non-repeating.</p>
     * Jonix-Comment: this field is optional
     */
     ...
     * order. Optional and non-repeating: see Group&nbsp;PR.8 introductory text for valid options.</p>
    ...
    /**
     * <p>A repeatable group of data elements which together represent a personal name, and specify its type. The
     * &lt;Name&gt; composite may be used to send alternate names for the same person, <em>eg</em> to handle such cases
     * as Ian Rankin writing as Jack Harvey.</p>
     * Jonix-Comment: this list may be empty
     */
    ...
    /**
     * <p>A repeatable group of data elements which together specify a date associated with the person identified in an
     * occurrence of the &lt;Contributor&gt; composite, <em>eg</em> birth or death.</p>
     * Jonix-Comment: this list may be empty
     */
    ...
    /**
     * <p>A repeatable group of data elements which together identify a contributor’s professional position and/or
     * affiliation, allowing multiple positions and affiliations to be specified.</p>
     * Jonix-Comment: this list may be empty
     */
    ...
    /**
     * <p>A biographical note about a contributor to the product. (See the &lt;OtherText&gt; composite in
     * Group&nbsp;PR.15 for a biographical note covering all contributors to a product in a single text.) Optional and
     * non-repeating. May occur with a person name or with a corporate name. A biographical note in ONIX should always
     * contain the name of the person or body concerned, and it should always be presented as a piece of continuous text
     * consisting of full sentences. Some recipients of ONIX data feeds will not accept text which has embedded URLs. A
     ...
     * to the party identified in an occurrence of the &lt;Contributor&gt; composite.</p>
     * Jonix-Comment: this list may be empty
     */
     ...
     * non-repeating. May only occur with a person name, not with a corporate name.</p><p><strong>The
     * &lt;ProfessionalAffiliation&gt; composite below provides a more general method of handling positions and
     * affiliations, and is to be preferred.</strong></p>
     * Jonix-Comment: this field is optional
     */
    ...
    /**
     * <p>An organisation to which a contributor to the product was affiliated at the time of its creation. Optional and
     * non-repeating. May only occur with a person name, not with a corporate name.</p><p><strong>The
     * &lt;ProfessionalAffiliation&gt; composite below provides a more general method of handling positions and
     * affiliations, and is to be preferred.</strong></p>
     * Jonix-Comment: this field is optional
    ...
    /**
     * <p>Brief text describing a contributor to the product, at the publisher’s discretion. Optional and non-repeating.
     * It may be used with either a person or corporate name, to draw attention to any aspect of a contributor’s
     * background which supports the promotion of the book.</p>
     * Jonix-Comment: this field is optional
     */
     ...
     * Group&nbsp;PR.8 introductory text for valid options.</p>
     * Jonix-Comment: this field is optional
     */
    ...
    /**
     * <p>A code identifying a country with which a contributor is particularly associated, when this is significant for
     * the marketing of a product. Optional and repeatable.</p>
     * Jonix-Comment: this list may be empty
     */
    ...
    /**
     * <p>An ONIX code identifying a region with which a contributor is particularly associated, when this is
     * significant for the marketing of a product. Optional and repeatable.</p>
     * Jonix-Comment: this list may be empty
     */
