 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link Contributor} ⯈ {@link CorporateName}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link Contributor} ⯈ {@link CorporateName}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link Contributor} ⯈ {@link CorporateName}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link Contributor} ⯈ {@link CorporateName}</li>
 * <li>{@link Product} ⯈ {@link Series} ⯈ {@link Contributor} ⯈ {@link CorporateName}</li>
 * <li>{@link Product} ⯈ {@link CopyrightStatement} ⯈ {@link CopyrightOwner} ⯈ {@link CorporateName}</li>
 * <li>{@link Product} ⯈ {@link Conference} ⯈ {@link ConferenceSponsor} ⯈ {@link CorporateName}</li>
 * </ul>
 */
