 ...
 * <ul>
 * <li>{@link ONIXMessage} ⯈ {@link Product} ⯈ {@link TradeAnnouncementDate}</li>
 * </ul>
 *
 * @since Onix-2.1
 */
public class TradeAnnouncementDate implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of TradeAnnouncementDate. Could be null if {@code exists == false}. Use {@link #value()}
