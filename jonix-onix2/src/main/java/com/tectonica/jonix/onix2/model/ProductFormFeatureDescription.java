...
public class ProductFormFeatureDescription
{
	...
	public static ProductFormFeatureDescription fromDoc(org.w3c.dom.Element element)
	{
		final ProductFormFeatureDescription x = new ProductFormFeatureDescription();
