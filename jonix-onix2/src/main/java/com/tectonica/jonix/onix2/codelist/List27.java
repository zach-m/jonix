...
public enum List27
{
	...
	/**
	 * See http://www.boersenverein.de/sixcms/media.php/976/WGSneuVersion2_0.pdf (in German).
	 */
	...
	/**
	 * Undervisningsdirektoratets fagkoder for kunnskapsløftet I videregående (Norwegian educational curriculum for secondary schools)
	 * (4708).
	 */
	Fagkoder("60"), //
	...
	/**
	 * Subject classification maintained by the Editorial Board of Chinese Library Classification. See http://cct.nlc.gov.cn for access to
	...
	private List27(String value)
	{
		this.value = value;
	}

	private static Map<String, List27> map;
	...
	public static List27 byValue(String value)
	{
