 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Price} ⯈ {@link BatchBonus} ⯈ {@link FreeQuantity}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link Price} ⯈ {@link BatchBonus} ⯈
...
public class FreeQuantity implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<FreeQuantity> action) {
        if (exists) {
            action.accept(this);
        }
    }
