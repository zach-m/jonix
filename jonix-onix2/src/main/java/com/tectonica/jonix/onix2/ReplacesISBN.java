 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;b010&gt;8474339790&lt;/b010&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ReplacesISBN}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class ReplacesISBN implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of ReplacesISBN. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public void ifExists(Consumer<ReplacesISBN> action) {
        if (exists) {
            action.accept(this);
        }
    }
