...
public class SeriesPartName implements OnixElement<String>, Serializable {
    ...
    public static final String refname = "SeriesPartName";
    public static final String shortname = "b282";
    ...
    public static final SeriesPartName EMPTY = new SeriesPartName();

    public SeriesPartName() {
        exists = false;
    }

    public SeriesPartName(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<SeriesPartName> action) {
        if (exists) {
            action.accept(this);
        }
    }
