 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link SupplierEANLocationNumber}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link NewSupplier} ⯈ {@link SupplierEANLocationNumber}</li>
 * </ul>
 */
public class SupplierEANLocationNumber implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<SupplierEANLocationNumber> action) {
        if (exists) {
            action.accept(this);
        }
    }
