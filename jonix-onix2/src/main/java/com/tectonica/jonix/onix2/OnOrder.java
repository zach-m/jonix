 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Stock} ⯈ {@link OnOrderDetail} ⯈ {@link OnOrder}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Stock} ⯈ {@link OnOrder}</li>
 * </ul>
 *
 * @since Onix-2.1
 */
public class OnOrder implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<OnOrder> action) {
        if (exists) {
            action.accept(this);
        }
    }
