...
public class CoverImageFormatCode
{
	...
	public FrontCoverImageFileFormatCodes value;

	public static CoverImageFormatCode fromDoc(org.w3c.dom.Element element)
	{
		final CoverImageFormatCode x = new CoverImageFormatCode();
		...
		x.value = FrontCoverImageFileFormatCodes.byValue(DU.getContentAsString(element));
