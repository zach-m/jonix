...
public class EpubSource
{
	...
	public EpublicationFormatCodes value;

	public static EpubSource fromDoc(org.w3c.dom.Element element)
	{
		final EpubSource x = new EpubSource();
		...
		x.value = EpublicationFormatCodes.byValue(DU.getContentAsString(element));
