...
import com.tectonica.jonix.onix2.codelist.List49;
import com.tectonica.jonix.onix2.codelist.List74;

public class TerritoryExcluded
{
	...
	public static TerritoryExcluded fromDoc(org.w3c.dom.Element element)
	{
		final TerritoryExcluded x = new TerritoryExcluded();
		...
		x.value = List49.byValue(DU.getContentAsString(element));
