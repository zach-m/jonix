 ...
 * <ul>
 * <li>{@link Header} ⯈ {@link ToPerson}</li>
 * </ul>
 */
public class ToPerson implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of ToPerson. Could be null if {@code exists() == false}. Use {@link #value()} instead if
    ...
    public void ifExists(Consumer<ToPerson> action) {
        if (exists) {
            action.accept(this);
        }
    }
