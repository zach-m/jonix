 ...
 * {@link Affiliation}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link Contributor} ⯈ {@link ProfessionalAffiliation} ⯈ {@link Affiliation}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link Contributor} ⯈ {@link ProfessionalAffiliation} ⯈ {@link Affiliation}</li>
 * <li>{@link Product} ⯈ {@link Series} ⯈ {@link Contributor} ⯈ {@link ProfessionalAffiliation} ⯈
 * {@link Affiliation}</li>
 * <li>{@link Product} ⯈ {@link Contributor} ⯈ {@link Affiliation}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link Contributor} ⯈ {@link Affiliation}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link Contributor} ⯈ {@link Affiliation}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link Contributor} ⯈ {@link Affiliation}</li>
 * <li>{@link Product} ⯈ {@link Series} ⯈ {@link Contributor} ⯈ {@link Affiliation}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class Affiliation implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<Affiliation> action) {
        if (exists) {
            action.accept(this);
        }
    }
