 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ContainedItem} ⯈ {@link ItemQuantity}</li>
 * </ul>
 */
public class ItemQuantity implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of ItemQuantity. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    /**
     * @return whether this tag (&lt;ItemQuantity&gt; or &lt;b015&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<ItemQuantity> action) {
        if (exists) {
            action.accept(this);
        }
    }
