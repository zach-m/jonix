...
public class TextPublicationDate
{
	...
	public static TextPublicationDate fromDoc(org.w3c.dom.Element element)
	{
		final TextPublicationDate x = new TextPublicationDate();
