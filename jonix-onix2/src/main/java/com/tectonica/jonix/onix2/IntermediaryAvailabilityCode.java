 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link IntermediaryAvailabilityCode}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class IntermediaryAvailabilityCode implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of IntermediaryAvailabilityCode. Could be null if {@code exists() == false}. Use
    ...
    public void ifExists(Consumer<IntermediaryAvailabilityCode> action) {
        if (exists) {
            action.accept(this);
        }
    }
