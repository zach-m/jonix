...
public class IntermediaryAvailabilityCode
{
	...
	public String value; // List63

	public static IntermediaryAvailabilityCode fromDoc(org.w3c.dom.Element element)
	{
		final IntermediaryAvailabilityCode x = new IntermediaryAvailabilityCode();
