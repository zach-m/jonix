 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link PagesRoman}</li>
 * </ul>
 */
public class PagesRoman implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of PagesRoman. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public void ifExists(Consumer<PagesRoman> action) {
        if (exists) {
            action.accept(this);
        }
    }
