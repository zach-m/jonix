 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link Publisher} ⯈ {@link NameCodeValue}</li>
 * <li>{@link Product} ⯈ {@link RelatedProduct} ⯈ {@link Publisher} ⯈ {@link NameCodeValue}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link Publisher} ⯈ {@link NameCodeValue}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link Publisher} ⯈ {@link NameCodeValue}</li>
 * <li>{@link Product} ⯈ {@link Imprint} ⯈ {@link NameCodeValue}</li>
 * </ul>
 */
public class NameCodeValue implements OnixElement<String>, Serializable {
    ...
    /**
     * @return whether this tag (&lt;NameCodeValue&gt; or &lt;b243&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<NameCodeValue> action) {
        if (exists) {
            action.accept(this);
        }
    }
