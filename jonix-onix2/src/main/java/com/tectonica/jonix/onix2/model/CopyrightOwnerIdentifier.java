...
public class CopyrightOwnerIdentifier
{
	...
	public static CopyrightOwnerIdentifier fromDoc(org.w3c.dom.Element element)
	{
		final CopyrightOwnerIdentifier x = new CopyrightOwnerIdentifier();
		...
		DU.forElementsOf(element, new DU.ElementListener()
		{
			...
			public void onElement(org.w3c.dom.Element element)
			{
				...
				if (name.equalsIgnoreCase(CopyrightOwnerIDType.refname) || name.equalsIgnoreCase(CopyrightOwnerIDType.shortname))
					x.copyrightOwnerIDType = CopyrightOwnerIDType.fromDoc(element);
