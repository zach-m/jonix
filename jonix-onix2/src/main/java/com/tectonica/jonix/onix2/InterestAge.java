 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link InterestAge}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class InterestAge implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of InterestAge. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    /**
     * @return whether this tag (&lt;InterestAge&gt; or &lt;b190&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<InterestAge> action) {
        if (exists) {
            action.accept(this);
        }
    }
