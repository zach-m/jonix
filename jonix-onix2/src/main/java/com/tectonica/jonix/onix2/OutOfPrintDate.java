 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link OutOfPrintDate}</li>
 * </ul>
 */
public class OutOfPrintDate implements OnixElement<String>, Serializable {
    private static final long serialVersionUID = 1L;

    public static final String refname = "OutOfPrintDate";
    public static final String shortname = "h134";
    ...
    /**
     * This is the raw content of OutOfPrintDate. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public static final OutOfPrintDate EMPTY = new OutOfPrintDate();

    public OutOfPrintDate() {
        exists = false;
    }

    public OutOfPrintDate(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<OutOfPrintDate> action) {
        if (exists) {
            action.accept(this);
        }
    }
