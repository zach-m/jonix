 ...
 * <ul>
 * <li>{@link ONIXMessage} ⯈ {@link Product} ⯈ {@link OutOfPrintDate}</li>
 * </ul>
 */
public class OutOfPrintDate implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of OutOfPrintDate. Could be null if {@code exists == false}. Use {@link #value()} instead
