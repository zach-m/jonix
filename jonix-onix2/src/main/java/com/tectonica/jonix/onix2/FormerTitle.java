 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link FormerTitle}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class FormerTitle implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of FormerTitle. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public void ifExists(Consumer<FormerTitle> action) {
        if (exists) {
            action.accept(this);
        }
    }
