...
public class ParentIdentifier
{
	...
	public SeriesIDType seriesIDType; // Required
	public IDTypeName idTypeName; // Optional
	public IDValue idValue; // Required

	public static ParentIdentifier fromDoc(org.w3c.dom.Element element)
	{
		final ParentIdentifier x = new ParentIdentifier();
		...
		DU.forElementsOf(element, new DU.ElementListener()
		{
			...
			public void onElement(org.w3c.dom.Element element)
			{
				...
				if (name.equalsIgnoreCase(SeriesIDType.refname) || name.equalsIgnoreCase(SeriesIDType.shortname))
					x.seriesIDType = SeriesIDType.fromDoc(element);
