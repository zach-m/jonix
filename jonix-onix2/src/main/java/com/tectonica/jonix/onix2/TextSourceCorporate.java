 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link OtherText} ⯈ {@link TextSourceCorporate}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link OtherText} ⯈ {@link TextSourceCorporate}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link OtherText} ⯈ {@link TextSourceCorporate}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link OtherText} ⯈ {@link TextSourceCorporate}</li>
 * </ul>
 *
 * @since Onix-2.1
 */
public class TextSourceCorporate implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<TextSourceCorporate> action) {
        if (exists) {
            action.accept(this);
        }
    }
