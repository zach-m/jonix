...
public class PublisherSeriesCode
{
	...
	public static PublisherSeriesCode fromDoc(org.w3c.dom.Element element)
	{
		final PublisherSeriesCode x = new PublisherSeriesCode();
