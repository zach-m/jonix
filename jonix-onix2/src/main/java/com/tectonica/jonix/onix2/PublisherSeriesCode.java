 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link Series} ⯈ {@link PublisherSeriesCode}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class PublisherSeriesCode implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of PublisherSeriesCode. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public static final PublisherSeriesCode EMPTY = new PublisherSeriesCode();

    public PublisherSeriesCode() {
        exists = false;
    }

    public PublisherSeriesCode(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<PublisherSeriesCode> action) {
        if (exists) {
            action.accept(this);
        }
    }
