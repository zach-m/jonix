...
public class TradeAnnouncementDate
{
	...
	public static TradeAnnouncementDate fromDoc(org.w3c.dom.Element element)
	{
		final TradeAnnouncementDate x = new TradeAnnouncementDate();
