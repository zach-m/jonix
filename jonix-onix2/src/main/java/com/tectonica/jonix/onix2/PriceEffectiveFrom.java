 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Price} ⯈ {@link PriceEffectiveFrom}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link Price} ⯈ {@link PriceEffectiveFrom}</li>
 * </ul>
 */
public class PriceEffectiveFrom implements OnixElement<String>, Serializable {
    private static final long serialVersionUID = 1L;

    public static final String refname = "PriceEffectiveFrom";
    public static final String shortname = "j161";
    ...
    public static final PriceEffectiveFrom EMPTY = new PriceEffectiveFrom();

    public PriceEffectiveFrom() {
        exists = false;
    }

    public PriceEffectiveFrom(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<PriceEffectiveFrom> action) {
        if (exists) {
            action.accept(this);
        }
    }
