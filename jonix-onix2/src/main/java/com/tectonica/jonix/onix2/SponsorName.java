 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;SponsorName&gt;Andersen Consulting&lt;/SponsorName&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SponsorName}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class SponsorName implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of SponsorName. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public void ifExists(Consumer<SponsorName> action) {
        if (exists) {
            action.accept(this);
        }
    }
