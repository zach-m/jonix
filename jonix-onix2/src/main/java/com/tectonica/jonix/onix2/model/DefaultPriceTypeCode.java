...
import com.tectonica.jonix.onix2.codelist.List58;
...
public class DefaultPriceTypeCode
{
	...
	public static DefaultPriceTypeCode fromDoc(org.w3c.dom.Element element)
	{
		final DefaultPriceTypeCode x = new DefaultPriceTypeCode();
		...
		x.value = List58.byValue(DU.getContentAsString(element));
