 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;DOI&gt;10.1006/jmbi.1998.2354&lt;/DOI&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
...
public class DOI implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of DOI. Could be null if {@code exists() == false}. Use {@link #value()} instead if you
    ...
    public static final DOI EMPTY = new DOI();

    public DOI() {
        exists = false;
    }

    public DOI(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<DOI> action) {
        if (exists) {
            action.accept(this);
        }
    }
