...
import com.tectonica.jonix.onix2.codelist.List95;

public class DefaultWeightUnit
{
	...
	public static DefaultWeightUnit fromDoc(org.w3c.dom.Element element)
	{
		final DefaultWeightUnit x = new DefaultWeightUnit();
		...
		x.value = List95.byValue(DU.getContentAsString(element));
