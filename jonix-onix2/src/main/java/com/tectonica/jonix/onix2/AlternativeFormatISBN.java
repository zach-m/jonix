...
public class AlternativeFormatISBN
{
	...
	public static AlternativeFormatISBN fromDoc(org.w3c.dom.Element element)
	{
		final AlternativeFormatISBN x = new AlternativeFormatISBN();
