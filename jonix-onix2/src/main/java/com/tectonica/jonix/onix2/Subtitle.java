 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link Subtitle}</li>
 * <li>{@link Product} ⯈ {@link Title} ⯈ {@link Subtitle}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link Title} ⯈ {@link Subtitle}</li>
 * <li>{@link Product} ⯈ {@link Set} ⯈ {@link Title} ⯈ {@link Subtitle}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link Title} ⯈ {@link Subtitle}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link Title} ⯈ {@link Subtitle}</li>
 * <li>{@link Product} ⯈ {@link Series} ⯈ {@link Title} ⯈ {@link Subtitle}</li>
 * </ul>
 *
 * @deprecated
 */
