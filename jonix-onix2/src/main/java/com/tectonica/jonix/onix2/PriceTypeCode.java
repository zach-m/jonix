 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Price} ⯈ {@link PriceTypeCode}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link Price} ⯈ {@link PriceTypeCode}</li>
 * </ul>
 */
public class PriceTypeCode implements OnixElement<PriceTypes>, Serializable {
    ...
    /**
     * @return whether this tag (&lt;PriceTypeCode&gt; or &lt;j148&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<PriceTypeCode> action) {
        if (exists) {
            action.accept(this);
        }
    }
