 ...
 * elements may be used in combination in applications where it is necessary to distinguish an initial word or character
 * string which is to be ignored for filing purposes, <em>eg</em> in library systems and in some bookshop databases.
 * <strong>The &lt;Title&gt; composite on a later page provides a more general method of handling all forms of title,
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link TitlePrefix}</li>
 * <li>{@link Product} ⯈ {@link Title} ⯈ {@link TitlePrefix}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link Title} ⯈ {@link TitlePrefix}</li>
 * <li>{@link Product} ⯈ {@link Set} ⯈ {@link Title} ⯈ {@link TitlePrefix}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link Title} ⯈ {@link TitlePrefix}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link Title} ⯈ {@link TitlePrefix}</li>
 * <li>{@link Product} ⯈ {@link Series} ⯈ {@link Title} ⯈ {@link TitlePrefix}</li>
 * </ul>
 *
 * @deprecated
 */
