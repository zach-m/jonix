...
public class AgentIdentifier
{
	...
	public AgentIDType agentIDType; // Required
	public IDTypeName idTypeName; // Optional
	public IDValue idValue; // Required

	public static AgentIdentifier fromDoc(org.w3c.dom.Element element)
	{
		final AgentIdentifier x = new AgentIdentifier();
		...
		DU.forElementsOf(element, new DU.ElementListener()
		{
			...
			public void onElement(org.w3c.dom.Element element)
			{
				...
				if (name.equalsIgnoreCase(AgentIDType.refname) || name.equalsIgnoreCase(AgentIDType.shortname))
					x.agentIDType = AgentIDType.fromDoc(element);
