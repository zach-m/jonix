 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link OtherText} ⯈ {@link EndDate}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link OtherText} ⯈ {@link EndDate}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link OtherText} ⯈ {@link EndDate}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link OtherText} ⯈ {@link EndDate}</li>
 * </ul>
 *
 * @since Onix-2.1
 */
