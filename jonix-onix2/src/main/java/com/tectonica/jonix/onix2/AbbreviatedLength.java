 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link Title} ⯈ {@link AbbreviatedLength}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link Title} ⯈ {@link AbbreviatedLength}</li>
 * <li>{@link Product} ⯈ {@link Set} ⯈ {@link Title} ⯈ {@link AbbreviatedLength}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link Title} ⯈ {@link AbbreviatedLength}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link Title} ⯈ {@link AbbreviatedLength}</li>
 * <li>{@link Product} ⯈ {@link Series} ⯈ {@link Title} ⯈ {@link AbbreviatedLength}</li>
 * </ul>
 */
public class AbbreviatedLength implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<AbbreviatedLength> action) {
        if (exists) {
            action.accept(this);
        }
    }
