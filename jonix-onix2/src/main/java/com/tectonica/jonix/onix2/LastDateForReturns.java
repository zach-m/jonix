 ...
 * <td><tt>&lt;LastDateForReturns&gt;</tt></td>
 * </tr>
 * <tr>
 * <td>Short tag</td>
 * <td><tt>&lt;j387&gt;</tt></td>
 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;j387&gt;20040616&lt;/j387&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link LastDateForReturns}</li>
 * </ul>
 *
 * @since Onix-2.11
 */
public class LastDateForReturns implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of LastDateForReturns. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public void ifExists(Consumer<LastDateForReturns> action) {
        if (exists) {
            action.accept(this);
        }
    }
