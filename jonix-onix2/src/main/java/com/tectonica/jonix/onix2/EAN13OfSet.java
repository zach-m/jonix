 ...
 */
@Deprecated
public class EAN13OfSet implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of EAN13OfSet. Could be null if {@code exists == false}. Use {@link #value()} instead if
    ...
    public static final EAN13OfSet EMPTY = new EAN13OfSet();

    public EAN13OfSet() {
        exists = false;
    }

    public EAN13OfSet(org.w3c.dom.Element element) {
        exists = true;
    ...
    /**
     * @return whether this tag (&lt;EAN13OfSet&gt; or &lt;b022&gt;) is explicitly provided in the ONIX XML
     */
    @Override
