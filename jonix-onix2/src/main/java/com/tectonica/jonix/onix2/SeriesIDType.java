...
public class SeriesIDType
{
	...
	public SeriesIdentifierTypeCodes value;

	public static SeriesIDType fromDoc(org.w3c.dom.Element element)
	{
		final SeriesIDType x = new SeriesIDType();
		...
		x.value = SeriesIdentifierTypeCodes.byValue(DU.getContentAsString(element));
