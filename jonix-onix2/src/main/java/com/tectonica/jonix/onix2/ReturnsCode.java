 ...
 * <ul>
 * <li>{@link ONIXMessage} ⯈ {@link Product} ⯈ {@link SupplyDetail} ⯈ {@link ReturnsCode}</li>
 * </ul>
 */
public class ReturnsCode implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of ReturnsCode. Could be null if {@code exists == false}. Use {@link #value()} instead if
