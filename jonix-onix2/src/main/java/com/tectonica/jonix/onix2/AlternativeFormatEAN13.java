 ...
 * <td><tt>&lt;AlternativeFormatEAN13&gt;</tt></td>
 * </tr>
 * <tr>
 * <td>Short tag</td>
 * <td><tt>&lt;h133&gt;</tt></td>
 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;AlternativeFormatEAN13&gt;9788474339796&lt;/AlternativeFormatEAN13&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link AlternativeFormatEAN13}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class AlternativeFormatEAN13 implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of AlternativeFormatEAN13. Could be null if {@code exists() == false}. Use
    ...
    /**
     * @return whether this tag (&lt;AlternativeFormatEAN13&gt; or &lt;h133&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<AlternativeFormatEAN13> action) {
        if (exists) {
            action.accept(this);
        }
    }
