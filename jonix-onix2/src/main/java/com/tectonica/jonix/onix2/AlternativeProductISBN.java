 ...
 * <ul>
 * <li>{@link ONIXMessage} ⯈ {@link Product} ⯈ {@link AlternativeProductISBN}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class AlternativeProductISBN implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of AlternativeProductISBN. Could be null if {@code exists == false}. Use {@link #value()}
