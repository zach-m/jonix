 ...
 * <ul>
 * <li>{@link ONIXMessage} ⯈ {@link Product} ⯈ {@link Series} ⯈ {@link SeriesISSN}</li>
 * </ul>
 *
 * @deprecated
 */
@Deprecated
public class SeriesISSN implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of SeriesISSN. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public static final SeriesISSN EMPTY = new SeriesISSN();
    ...
    /**
     * @return whether this tag (&lt;SeriesISSN&gt; or &lt;b016&gt;) is explicitly provided in the ONIX XML
     */
    @Override
