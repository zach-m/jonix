 ...
 * <tr>
 * <td>Example</td>
 * <td>&lt;ProductIDType&gt;02&lt;/ProductIDType&gt;&#160;&#160;&#160;&#160;ISBN</td>
 * </tr>
 * </table>
 */
public class ProductIDType implements OnixElement, Serializable
{
	...
	public ProductIDType(org.w3c.dom.Element element)
	{
		...
		value = ProductIdentifierTypes.byValue(JPU.getContentAsString(element));
	}
}
