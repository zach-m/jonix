...
public class ProductIDType
{
	...
	public ProductIdentifierTypeCodes value;

	public static ProductIDType fromDoc(org.w3c.dom.Element element)
	{
		final ProductIDType x = new ProductIDType();
		...
		x.value = ProductIdentifierTypeCodes.byValue(DU.getContentAsString(element));
