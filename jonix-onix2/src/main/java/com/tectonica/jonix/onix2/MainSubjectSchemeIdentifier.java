...
public class MainSubjectSchemeIdentifier
{
	...
	public MainSubjectSchemeIdentifierCodes value;

	public static MainSubjectSchemeIdentifier fromDoc(org.w3c.dom.Element element)
	{
		final MainSubjectSchemeIdentifier x = new MainSubjectSchemeIdentifier();
		...
		x.value = MainSubjectSchemeIdentifierCodes.byValue(DU.getContentAsString(element));
