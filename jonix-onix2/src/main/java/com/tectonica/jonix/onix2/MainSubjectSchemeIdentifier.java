...
public class MainSubjectSchemeIdentifier implements JonixElement, Serializable
{
	...
	public MainSubjectSchemeIdentifier(org.w3c.dom.Element element)
	{
		...
		value = MainSubjectSchemeIdentifiers.byValue(JPU.getContentAsString(element));
	}
}
