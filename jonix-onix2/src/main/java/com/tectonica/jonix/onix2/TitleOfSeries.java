 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;TitleOfSeries&gt;Blue
 * Guides&lt;/TitleOfSeries&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link ONIXMessage} ⯈ {@link Product} ⯈ {@link Series} ⯈ {@link TitleOfSeries}</li>
 * </ul>
 */
public class TitleOfSeries implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of TitleOfSeries. Could be null if {@code exists == false}. Use {@link #value()} instead
    ...
    public static final TitleOfSeries EMPTY = new TitleOfSeries();

    public TitleOfSeries() {
        exists = false;
    }

    public TitleOfSeries(org.w3c.dom.Element element) {
        exists = true;
    ...
    /**
     * @return whether this tag (&lt;TitleOfSeries&gt; or &lt;b018&gt;) is explicitly provided in the ONIX XML
     */
    @Override
