...
import com.tectonica.jonix.onix2.codelist.List59;
...
public class PriceQualifier
{
	...
	public static PriceQualifier fromDoc(org.w3c.dom.Element element)
	{
		final PriceQualifier x = new PriceQualifier();
		...
		x.value = List59.byValue(DU.getContentAsString(element));
