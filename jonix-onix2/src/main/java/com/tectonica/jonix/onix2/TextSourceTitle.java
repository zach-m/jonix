 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link OtherText} ⯈ {@link TextSourceTitle}</li>
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link OtherText} ⯈ {@link TextSourceTitle}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link OtherText} ⯈ {@link TextSourceTitle}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link OtherText} ⯈ {@link TextSourceTitle}</li>
 * </ul>
 */
public class TextSourceTitle implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<TextSourceTitle> action) {
        if (exists) {
            action.accept(this);
        }
    }
