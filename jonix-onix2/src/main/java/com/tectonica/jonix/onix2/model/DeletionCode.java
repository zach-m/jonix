...
import com.tectonica.jonix.onix2.codelist.List2;
...
public class DeletionCode
{
	...
	public static DeletionCode fromDoc(org.w3c.dom.Element element)
	{
		final DeletionCode x = new DeletionCode();
		...
		x.value = List2.byValue(DU.getContentAsString(element));
