 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link TranslationOfTitle}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class TranslationOfTitle implements OnixElement<String>, Serializable {
    ...
    public static final String refname = "TranslationOfTitle";
    public static final String shortname = "b032";
    ...
    /**
     * This is the raw content of TranslationOfTitle. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public static final TranslationOfTitle EMPTY = new TranslationOfTitle();

    public TranslationOfTitle() {
        exists = false;
    }

    public TranslationOfTitle(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<TranslationOfTitle> action) {
        if (exists) {
            action.accept(this);
        }
    }
