...
public class MarketRestrictionDetail
{
	...
	public static MarketRestrictionDetail fromDoc(org.w3c.dom.Element element)
	{
		final MarketRestrictionDetail x = new MarketRestrictionDetail();
