 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;ReplacedByISBN&gt;8474339790&lt;/ReplacedByISBN&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ReplacedByISBN}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class ReplacedByISBN implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of ReplacedByISBN. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public static final ReplacedByISBN EMPTY = new ReplacedByISBN();
    ...
    public void ifExists(Consumer<ReplacedByISBN> action) {
        if (exists) {
            action.accept(this);
        }
    }
