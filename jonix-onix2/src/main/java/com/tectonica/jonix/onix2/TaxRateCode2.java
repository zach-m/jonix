 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Price} ⯈ {@link TaxRateCode2}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link Price} ⯈ {@link TaxRateCode2}</li>
 * </ul>
 */
public class TaxRateCode2 implements OnixElement<TaxRateTypes>, Serializable {
    ...
    public void ifExists(Consumer<TaxRateCode2> action) {
        if (exists) {
            action.accept(this);
        }
    }
