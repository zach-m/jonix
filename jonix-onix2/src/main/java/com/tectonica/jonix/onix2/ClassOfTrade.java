 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Price} ⯈ {@link ClassOfTrade}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link Price} ⯈ {@link ClassOfTrade}</li>
 * </ul>
 */
public class ClassOfTrade implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<ClassOfTrade> action) {
        if (exists) {
            action.accept(this);
        }
    }
