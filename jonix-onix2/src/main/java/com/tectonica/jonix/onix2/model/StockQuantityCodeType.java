...
import com.tectonica.jonix.onix2.codelist.List70;
...
public class StockQuantityCodeType
{
	...
	public static StockQuantityCodeType fromDoc(org.w3c.dom.Element element)
	{
		final StockQuantityCodeType x = new StockQuantityCodeType();
		...
		x.value = List70.byValue(DU.getContentAsString(element));
