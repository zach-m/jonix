...
public class MediaFileDate implements OnixElement<String>, Serializable {
    ...
    public static final String refname = "MediaFileDate";
    public static final String shortname = "f373";
    ...
    /**
     * This is the raw content of MediaFileDate. Could be null if {@code exists == false}. Use {@link #value()} instead
    ...
    public static final MediaFileDate EMPTY = new MediaFileDate();

    public MediaFileDate() {
        exists = false;
    }

    public MediaFileDate(org.w3c.dom.Element element) {
        exists = true;
    ...
    /**
     * @return whether this tag (&lt;MediaFileDate&gt; or &lt;f373&gt;) is explicitly provided in the ONIX XML
     */
    @Override
