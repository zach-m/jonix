...
import com.tectonica.jonix.onix2.codelist.List55;
...
public class DateFormat
{
	...
	public static DateFormat fromDoc(org.w3c.dom.Element element)
	{
		final DateFormat x = new DateFormat();
		...
		x.value = List55.byValue(DU.getContentAsString(element));
