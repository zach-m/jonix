 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link EpubTypeDescription}</li>
 * <li>{@link Product} ⯈ {@link RelatedProduct} ⯈ {@link EpubTypeDescription}</li>
 * </ul>
 */
public class EpubTypeDescription implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<EpubTypeDescription> action) {
        if (exists) {
            action.accept(this);
        }
    }
