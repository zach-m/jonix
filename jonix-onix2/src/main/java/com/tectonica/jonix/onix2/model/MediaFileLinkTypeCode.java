...
import com.tectonica.jonix.onix2.codelist.List40;
...
public class MediaFileLinkTypeCode
{
	...
	public static MediaFileLinkTypeCode fromDoc(org.w3c.dom.Element element)
	{
		final MediaFileLinkTypeCode x = new MediaFileLinkTypeCode();
		...
		x.value = List40.byValue(DU.getContentAsString(element));
