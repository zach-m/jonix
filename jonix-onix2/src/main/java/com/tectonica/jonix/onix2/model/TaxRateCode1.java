...
import com.tectonica.jonix.onix2.codelist.List62;
...
public class TaxRateCode1
{
	...
	public static TaxRateCode1 fromDoc(org.w3c.dom.Element element)
	{
		final TaxRateCode1 x = new TaxRateCode1();
		...
		x.value = List62.byValue(DU.getContentAsString(element));
