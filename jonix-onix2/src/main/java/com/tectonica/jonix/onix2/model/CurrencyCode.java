...
import com.tectonica.jonix.onix2.codelist.List96;
...
public class CurrencyCode
{
	...
	public static CurrencyCode fromDoc(org.w3c.dom.Element element)
	{
		final CurrencyCode x = new CurrencyCode();
		...
		x.value = List96.byValue(DU.getContentAsString(element));
