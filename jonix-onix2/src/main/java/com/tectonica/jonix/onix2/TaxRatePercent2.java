 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Price} ⯈ {@link TaxRatePercent2}</li>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Reissue} ⯈ {@link Price} ⯈ {@link TaxRatePercent2}</li>
 * </ul>
 */
public class TaxRatePercent2 implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of TaxRatePercent2. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public void ifExists(Consumer<TaxRatePercent2> action) {
        if (exists) {
            action.accept(this);
        }
    }
