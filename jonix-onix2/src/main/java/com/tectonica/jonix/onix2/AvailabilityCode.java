...
public class AvailabilityCode
{
	...
	public AvailabilityStatusCodes value;

	public static AvailabilityCode fromDoc(org.w3c.dom.Element element)
	{
		final AvailabilityCode x = new AvailabilityCode();
		...
		x.value = AvailabilityStatusCodes.byValue(DU.getContentAsString(element));
