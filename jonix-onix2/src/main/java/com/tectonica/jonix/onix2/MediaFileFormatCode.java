...
public class MediaFileFormatCode
{
	...
	public ImageAudioVideoFileFormatCodes value;

	public static MediaFileFormatCode fromDoc(org.w3c.dom.Element element)
	{
		final MediaFileFormatCode x = new MediaFileFormatCode();
		...
		x.value = ImageAudioVideoFileFormatCodes.byValue(DU.getContentAsString(element));
