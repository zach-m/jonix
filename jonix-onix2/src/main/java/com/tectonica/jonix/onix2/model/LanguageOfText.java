...
public class LanguageOfText
{
	...
	public static LanguageOfText fromDoc(org.w3c.dom.Element element)
	{
		final LanguageOfText x = new LanguageOfText();
		...
		x.value = List74.byValue(DU.getContentAsString(element));
