...
public class TextCaseFlag
{
	...
	public static TextCaseFlag fromDoc(org.w3c.dom.Element element)
	{
		final TextCaseFlag x = new TextCaseFlag();
		...
		x.value = TextCaseFlags.byValue(DU.getContentAsString(element));
