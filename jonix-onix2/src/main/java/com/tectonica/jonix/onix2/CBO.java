...
/**
 * <h1>Committed backorder quantity</h1>
 * <p>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link SupplyDetail} ⯈ {@link Stock} ⯈ {@link CBO}</li>
 * </ul>
 *
 * @since Onix-2.1
 */
public class CBO implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<CBO> action) {
        if (exists) {
            action.accept(this);
        }
    }
