...
import com.tectonica.jonix.onix2.codelist.List53;
...
public class ReturnsCodeType
{
	...
	public static ReturnsCodeType fromDoc(org.w3c.dom.Element element)
	{
		final ReturnsCodeType x = new ReturnsCodeType();
		...
		x.value = List53.byValue(DU.getContentAsString(element));
