...
import com.tectonica.jonix.onix2.codelist.List47;
...
public class RightsRegion
{
	...
	public static RightsRegion fromDoc(org.w3c.dom.Element element)
	{
		final RightsRegion x = new RightsRegion();
		...
		x.value = List47.byValue(DU.getContentAsString(element));
