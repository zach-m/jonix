 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link OriginalPublisher}</li>
 * </ul>
 *
 * @deprecated
 */
...
public class OriginalPublisher implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of OriginalPublisher. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public void ifExists(Consumer<OriginalPublisher> action) {
        if (exists) {
            action.accept(this);
        }
    }
