...
import com.tectonica.jonix.codelist.SupplytoRegionCodes;
...
public class SupplyToRegion
{
	...
	public SupplytoRegionCodes value;

	public static SupplyToRegion fromDoc(org.w3c.dom.Element element)
	{
		final SupplyToRegion x = new SupplyToRegion();
		...
		x.value = SupplytoRegionCodes.byValue(DU.getContentAsString(element));
