...
import com.tectonica.jonix.onix2.codelist.List18;
...
public class PersonNameType
{
	...
	public static PersonNameType fromDoc(org.w3c.dom.Element element)
	{
		final PersonNameType x = new PersonNameType();
		...
		x.value = List18.byValue(DU.getContentAsString(element));
