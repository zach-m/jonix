...
import com.tectonica.jonix.onix2.codelist.List25;
...
public class IllustrationType
{
	...
	public static IllustrationType fromDoc(org.w3c.dom.Element element)
	{
		final IllustrationType x = new IllustrationType();
		...
		x.value = List25.byValue(DU.getContentAsString(element));
