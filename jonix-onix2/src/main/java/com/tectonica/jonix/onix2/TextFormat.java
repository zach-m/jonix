...
public class TextFormat
{
	...
	public TextFormatCodes value;

	public static TextFormat fromDoc(org.w3c.dom.Element element)
	{
		final TextFormat x = new TextFormat();
		...
		x.value = TextFormatCodes.byValue(DU.getContentAsString(element));
