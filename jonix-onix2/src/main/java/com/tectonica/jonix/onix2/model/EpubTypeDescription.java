...
public class EpubTypeDescription
{
	...
	public static EpubTypeDescription fromDoc(org.w3c.dom.Element element)
	{
		final EpubTypeDescription x = new EpubTypeDescription();
