 ...
 * <li>{@link Product} ⯈ {@link ContentItem} ⯈ {@link Contributor} ⯈ {@link ProfessionalAffiliation}</li>
 * <li>{@link SubSeriesRecord} ⯈ {@link Contributor} ⯈ {@link ProfessionalAffiliation}</li>
 * <li>{@link MainSeriesRecord} ⯈ {@link Contributor} ⯈ {@link ProfessionalAffiliation}</li>
 * <li>{@link Product} ⯈ {@link Series} ⯈ {@link Contributor} ⯈ {@link ProfessionalAffiliation}</li>
 * </ul>
 *
 * @since Onix-2.1
 */
