...
import com.tectonica.jonix.onix2.codelist.List75;

public class PersonDateRole
{
	...
	public static PersonDateRole fromDoc(org.w3c.dom.Element element)
	{
		final PersonDateRole x = new PersonDateRole();
		...
		x.value = List75.byValue(DU.getContentAsString(element));
