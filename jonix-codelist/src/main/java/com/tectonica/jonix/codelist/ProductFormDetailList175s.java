 ...
 * Product form detail
 */
public enum ProductFormDetailList175s
{
	/**
	 * CD ‘red book’ format.
	 */
	...
	private ProductFormDetailList175s(String value)
	{
		this.value = value;
	}

	private static Map<String, ProductFormDetailList175s> map;
	...
	private static Map<String, ProductFormDetailList175s> map()
	{
		...
		{
			map = new HashMap<>();
			for (ProductFormDetailList175s e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static ProductFormDetailList175s byValue(String value)
	{
