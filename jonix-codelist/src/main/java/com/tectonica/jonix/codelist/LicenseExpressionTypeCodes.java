 ...
 */
public enum LicenseExpressionTypeCodes
{
	/**
	...
	private LicenseExpressionTypeCodes(String value)
	{
		this.value = value;
	}

	public static LicenseExpressionTypeCodes byValue(String value)
	{
		if (value == null || value.isEmpty())
			return null;
		for (LicenseExpressionTypeCodes e : values())
