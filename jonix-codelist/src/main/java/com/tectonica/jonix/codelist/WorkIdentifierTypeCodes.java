 ...
 */
public enum WorkIdentifierTypeCodes
{
	Proprietary("01"), //
	...
	private WorkIdentifierTypeCodes(String value)
	{
		this.value = value;
	}

	public static WorkIdentifierTypeCodes byValue(String value)
	{
		if (value == null || value.isEmpty())
			return null;
		for (WorkIdentifierTypeCodes e : values())
