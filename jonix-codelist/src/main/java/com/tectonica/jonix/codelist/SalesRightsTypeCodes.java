 ...
 */
public enum SalesRightsTypeCodes
{
	/**
	...
	private SalesRightsTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, SalesRightsTypeCodes> map;
	...
	private static Map<String, SalesRightsTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (SalesRightsTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static SalesRightsTypeCodes byValue(String value)
	{
