...
public enum EditionTypeCodes
{
	...
	private EditionTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, EditionTypeCodes> map;
	...
	private static Map<String, EditionTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (EditionTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static EditionTypeCodes byValue(String value)
	{
