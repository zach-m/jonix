 ...
 */
public enum TransliterationSchemeCodes
{
	/**
	...
	private TransliterationSchemeCodes(String value)
	{
		this.value = value;
	}

	public static TransliterationSchemeCodes byValue(String value)
	{
		if (value == null || value.isEmpty())
			return null;
		for (TransliterationSchemeCodes e : values())
