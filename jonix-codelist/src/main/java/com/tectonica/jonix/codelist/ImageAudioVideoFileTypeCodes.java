 ...
 */
public enum ImageAudioVideoFileTypeCodes
{
	/**
	...
	private ImageAudioVideoFileTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, ImageAudioVideoFileTypeCodes> map;
	...
	private static Map<String, ImageAudioVideoFileTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (ImageAudioVideoFileTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static ImageAudioVideoFileTypeCodes byValue(String value)
	{
