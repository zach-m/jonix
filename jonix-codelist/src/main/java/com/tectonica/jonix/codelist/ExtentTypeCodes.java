...
public enum ExtentTypeCodes
{
	...
	private ExtentTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, ExtentTypeCodes> map;
	...
	private static Map<String, ExtentTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (ExtentTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static ExtentTypeCodes byValue(String value)
	{
