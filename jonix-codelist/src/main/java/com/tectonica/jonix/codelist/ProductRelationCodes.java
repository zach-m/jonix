 ...
 */
public enum ProductRelationCodes
{
	/**
	...
	private ProductRelationCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, ProductRelationCodes> map;
	...
	private static Map<String, ProductRelationCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (ProductRelationCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static ProductRelationCodes byValue(String value)
	{
