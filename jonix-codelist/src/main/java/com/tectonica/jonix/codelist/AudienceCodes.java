...
public enum AudienceCodes
{
	...
	private AudienceCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, AudienceCodes> map;
	...
	private static Map<String, AudienceCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (AudienceCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static AudienceCodes byValue(String value)
	{
