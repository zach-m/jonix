...
public enum LanguageRoleCodes
{
	...
	private LanguageRoleCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, LanguageRoleCodes> map;
	...
	private static Map<String, LanguageRoleCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (LanguageRoleCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static LanguageRoleCodes byValue(String value)
	{
