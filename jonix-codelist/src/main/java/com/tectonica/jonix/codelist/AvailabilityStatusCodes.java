 ...
 */
public enum AvailabilityStatusCodes
{
	/**
	...
	private AvailabilityStatusCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, AvailabilityStatusCodes> map;
	...
	private static Map<String, AvailabilityStatusCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (AvailabilityStatusCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static AvailabilityStatusCodes byValue(String value)
	{
