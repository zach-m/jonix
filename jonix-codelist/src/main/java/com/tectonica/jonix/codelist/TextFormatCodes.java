...
public enum TextFormatCodes
{
	...
	private TextFormatCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, TextFormatCodes> map;
	...
	private static Map<String, TextFormatCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (TextFormatCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static TextFormatCodes byValue(String value)
	{
