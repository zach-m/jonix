...
public enum ProductFormFeatureValueDvdRegionCodess
{
	...
	private ProductFormFeatureValueDvdRegionCodess(String value)
	{
		this.value = value;
	}

	private static Map<String, ProductFormFeatureValueDvdRegionCodess> map;
	...
	private static Map<String, ProductFormFeatureValueDvdRegionCodess> map()
	{
		...
		{
			map = new HashMap<>();
			for (ProductFormFeatureValueDvdRegionCodess e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static ProductFormFeatureValueDvdRegionCodess byValue(String value)
	{
