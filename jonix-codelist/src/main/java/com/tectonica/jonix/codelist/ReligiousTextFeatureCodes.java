 ...
 */
public enum ReligiousTextFeatureCodes
{
	/**
	...
	private ReligiousTextFeatureCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, ReligiousTextFeatureCodes> map;
	...
	private static Map<String, ReligiousTextFeatureCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (ReligiousTextFeatureCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static ReligiousTextFeatureCodes byValue(String value)
	{
