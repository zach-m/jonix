 ...
 */
public enum OtherTextTypeCodes
{
	Main_description("01"), //
	...
	private OtherTextTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, OtherTextTypeCodes> map;
	...
	private static Map<String, OtherTextTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (OtherTextTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static OtherTextTypeCodes byValue(String value)
	{
