...
public enum TextItemTypeCodes
{
	...
	private TextItemTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, TextItemTypeCodes> map;
	...
	private static Map<String, TextItemTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (TextItemTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static TextItemTypeCodes byValue(String value)
	{
