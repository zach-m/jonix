 ...
 */
public enum NotificationOrUpdateTypeCodes
{
	/**
	...
	private NotificationOrUpdateTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, NotificationOrUpdateTypeCodes> map;
	...
	private static Map<String, NotificationOrUpdateTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (NotificationOrUpdateTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static NotificationOrUpdateTypeCodes byValue(String value)
	{
