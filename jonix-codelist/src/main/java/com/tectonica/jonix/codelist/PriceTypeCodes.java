...
public enum PriceTypeCodes
{
	...
	private PriceTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, PriceTypeCodes> map;
	...
	private static Map<String, PriceTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (PriceTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static PriceTypeCodes byValue(String value)
	{
