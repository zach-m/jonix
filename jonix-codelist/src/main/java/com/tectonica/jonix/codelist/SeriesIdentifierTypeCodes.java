 ...
 */
public enum SeriesIdentifierTypeCodes
{
	/**
	...
	private SeriesIdentifierTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, SeriesIdentifierTypeCodes> map;
	...
	private static Map<String, SeriesIdentifierTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (SeriesIdentifierTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static SeriesIdentifierTypeCodes byValue(String value)
	{
