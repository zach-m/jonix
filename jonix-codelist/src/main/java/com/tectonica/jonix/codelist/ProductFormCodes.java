...
public enum ProductFormCodes
{
	...
	private ProductFormCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, ProductFormCodes> map;
	...
	private static Map<String, ProductFormCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (ProductFormCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static ProductFormCodes byValue(String value)
	{
