 ...
 */
public enum UsCpsiaChokingHazardWarningCodeList143s
{
	/**
	...
	private UsCpsiaChokingHazardWarningCodeList143s(String value)
	{
		this.value = value;
	}

	public static UsCpsiaChokingHazardWarningCodeList143s byValue(String value)
	{
		if (value == null || value.isEmpty())
			return null;
		for (UsCpsiaChokingHazardWarningCodeList143s e : values())
