 ...
 */
public enum PrizeOrAwardAchievementCodes
{
	Winner("01"), //
	...
	private PrizeOrAwardAchievementCodes(String value)
	{
		this.value = value;
	}

	public static PrizeOrAwardAchievementCodes byValue(String value)
	{
		if (value == null || value.isEmpty())
			return null;
		for (PrizeOrAwardAchievementCodes e : values())
