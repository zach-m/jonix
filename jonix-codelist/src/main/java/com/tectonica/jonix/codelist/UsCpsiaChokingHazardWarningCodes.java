 ...
 */
public enum UsCpsiaChokingHazardWarningCodes
{
	/**
	...
	private UsCpsiaChokingHazardWarningCodes(String value)
	{
		this.value = value;
	}

	public static UsCpsiaChokingHazardWarningCodes byValue(String value)
	{
		if (value == null || value.isEmpty())
			return null;
		for (UsCpsiaChokingHazardWarningCodes e : values())
