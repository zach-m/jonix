 ...
 */
public enum PublishingRoleCodes
{
	Publisher("01"), //
	...
	private PublishingRoleCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, PublishingRoleCodes> map;
	...
	private static Map<String, PublishingRoleCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (PublishingRoleCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static PublishingRoleCodes byValue(String value)
	{
