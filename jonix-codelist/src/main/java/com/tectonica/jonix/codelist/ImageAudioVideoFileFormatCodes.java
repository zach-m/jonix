 ...
 */
public enum ImageAudioVideoFileFormatCodes
{
	GIF("02"), //
	...
	private ImageAudioVideoFileFormatCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, ImageAudioVideoFileFormatCodes> map;
	...
	private static Map<String, ImageAudioVideoFileFormatCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (ImageAudioVideoFileFormatCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static ImageAudioVideoFileFormatCodes byValue(String value)
	{
