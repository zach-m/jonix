...
public enum TitleTypeCodes
{
	...
	private TitleTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, TitleTypeCodes> map;
	...
	private static Map<String, TitleTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (TitleTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static TitleTypeCodes byValue(String value)
	{
