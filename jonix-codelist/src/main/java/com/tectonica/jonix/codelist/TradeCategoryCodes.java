 ...
 * Trade category code
 */
public enum TradeCategoryCodes
{
	/**
	...
	private TradeCategoryCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, TradeCategoryCodes> map;
	...
	private static Map<String, TradeCategoryCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (TradeCategoryCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static TradeCategoryCodes byValue(String value)
	{
