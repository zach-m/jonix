 ...
 */
public enum EpublicationTypeCodes
{
	/**
	...
	private EpublicationTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, EpublicationTypeCodes> map;
	...
	private static Map<String, EpublicationTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (EpublicationTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static EpublicationTypeCodes byValue(String value)
	{
