 ...
 */
public enum SubjectSchemeIdentifierCodes
{
	/**
	...
	private SubjectSchemeIdentifierCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, SubjectSchemeIdentifierCodes> map;
	...
	private static Map<String, SubjectSchemeIdentifierCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (SubjectSchemeIdentifierCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static SubjectSchemeIdentifierCodes byValue(String value)
	{
