 ...
 */
public enum IllustrationAndOtherContentTypeCodes
{
	/**
	...
	private IllustrationAndOtherContentTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, IllustrationAndOtherContentTypeCodes> map;
	...
	private static Map<String, IllustrationAndOtherContentTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (IllustrationAndOtherContentTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static IllustrationAndOtherContentTypeCodes byValue(String value)
	{
