 ...
 */
public enum EpublicationFormatCodes
{
	HTML("01"), //
	...
	private EpublicationFormatCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, EpublicationFormatCodes> map;
	...
	private static Map<String, EpublicationFormatCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (EpublicationFormatCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static EpublicationFormatCodes byValue(String value)
	{
