 ...
 */
public enum UnpricedItemTypeCodes
{
	Free_of_charge("01"), //
	...
	private UnpricedItemTypeCodes(String value)
	{
		this.value = value;
	}

	public static UnpricedItemTypeCodes byValue(String value)
	{
		if (value == null || value.isEmpty())
			return null;
		for (UnpricedItemTypeCodes e : values())
