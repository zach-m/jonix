 ...
 */
public enum RecordSourceTypeCodes
{
	Unspecified("00"), //
	...
	private RecordSourceTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, RecordSourceTypeCodes> map;
	...
	private static Map<String, RecordSourceTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (RecordSourceTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static RecordSourceTypeCodes byValue(String value)
	{
