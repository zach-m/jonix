 ...
 */
public enum ProductIdentifierTypeCodes
{
	/**
	...
	private ProductIdentifierTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, ProductIdentifierTypeCodes> map;
	...
	private static Map<String, ProductIdentifierTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (ProductIdentifierTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static ProductIdentifierTypeCodes byValue(String value)
	{
