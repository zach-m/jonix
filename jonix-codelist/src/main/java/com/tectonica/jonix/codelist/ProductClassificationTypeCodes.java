 ...
 */
public enum ProductClassificationTypeCodes
{
	/**
	...
	private ProductClassificationTypeCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, ProductClassificationTypeCodes> map;
	...
	private static Map<String, ProductClassificationTypeCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (ProductClassificationTypeCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static ProductClassificationTypeCodes byValue(String value)
	{
