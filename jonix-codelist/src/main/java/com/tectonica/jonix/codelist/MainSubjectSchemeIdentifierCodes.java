 ...
 */
public enum MainSubjectSchemeIdentifierCodes
{
	/**
	...
	private MainSubjectSchemeIdentifierCodes(String value)
	{
		this.value = value;
	}

	private static Map<String, MainSubjectSchemeIdentifierCodes> map;
	...
	private static Map<String, MainSubjectSchemeIdentifierCodes> map()
	{
		...
		{
			map = new HashMap<>();
			for (MainSubjectSchemeIdentifierCodes e : values())
				map.put(e.value, e);
		}
		return map;
	}

	public static MainSubjectSchemeIdentifierCodes byValue(String value)
	{
