...
public class ISBNHyphenAppender {
     ...
     * <p>
     * In an ISBN-10 with hyphens, these hyphens separate the number of the group (similar but no equal to country), the
     ...
     * @throws IllegalArgumentException      if the length of the ISBN-10 provided is not 10
     * @throws UnsupportedOperationException if the ISBN-10 provided is from a ISBN group not implemented
     * @deprecated
     */
    @Deprecated
     ...
     * <p>
     * In an ISBN-13 with hyphens, these hyphens separate the first three digits, the number of the group (similar but
     * no equal to country), the number of the editor, the number of the title and the "checksum" number.
     *
     ...
     * @throws IllegalArgumentException      if the length of the ISBN-13 provided is not 13
     * @throws UnsupportedOperationException if the ISBN-13 provided is from a ISBN group not implemented
     * @deprecated
     */
    @Deprecated
     ...
     * <p>
     * In an ISBN-10 with hyphens, these hyphens separate the number of the group (similar but no equal to country), the
     * number of the editor, the number of the title and the "checksum" number. The ISBN-13 adds a 3 digit code before.
     *
     * @param ISBN ISBN to which hyphens are to be added
     * @return the ISBN with the added hyphens
     * @throws NullPointerException          if the ISBN-10 provided is {@code null}
     * @throws IllegalArgumentException      if the length of the ISBN provided is not 10 or 13
     * @throws UnsupportedOperationException if the ISBN provided is from a ISBN group not implemented
     */
    public String appendHyphenToISBN(String ISBN) {
        ...
        String publisherPart = ISBN.substring(groupNumberLength).substring(0, maximumPublisherNumerLength);
    ...
    /**
     * Right pad a {@code String} with the specified {@code character}. The string is padded to the size of {@code
     * maxLength}.
     *
     * @param the       String to pad
     * @param character the character to pad with
     * @param maxLength the size to pad to
     * @return right padded {@code String} or original {@code String} if no padding is necessary
