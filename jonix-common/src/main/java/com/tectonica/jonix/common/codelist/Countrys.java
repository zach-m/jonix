...
/**
 * marker interface to assist in IDE navigation to code-list 91 (Country - based on ISO 3166-1)
 */
 ...
 * <p>
 * Description: Country - based on ISO 3166-1
 *
 * @see <a href="https://www.editeur.org/14/Code-Lists/">About ONIX Codelists</a>
 * @see <a href="https://ns.editeur.org/onix/en/">ONIX online Codelist browser</a>
 * @see <a href=
 *      "https://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_68.html#codelist91">ONIX
...
public enum Countrys implements OnixCodelist, CodeList91 {
    ...
    Countrys(String code, String description) {
        this.code = code;
    ...
    private static Map<String, Countrys> map() {
        Map<String, Countrys> result = map;
        if (result == null) {
            synchronized (Countrys.class) {
                result = map;
                if (result == null) {
                    result = new HashMap<>();
                    for (Countrys e : values()) {
                        result.put(e.code, e);
                    }
                    map = result;
                }
    ...
    public static Countrys byCode(String code) {
    ...
    public static Optional<Countrys> byCodeOptional(String code) {
