 ...
 * @see <a href=
 *      "https://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_71.html#codelist228">ONIX
...
public enum GrantIdentifierTypes implements OnixCodelist, CodeList228 {
     ...
     */
    Proprietary_grant_ID_scheme("01", "Proprietary grant ID scheme"),
    ...
    public static Optional<GrantIdentifierTypes> byCodeOptional(String code) {
