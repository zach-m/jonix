 ...
 * @see <a href=
 *      "https://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_60.html#codelist48">ONIX
...
public enum MeasureTypes implements OnixCodelist, CodeList48 {
     ...
     * volumetric unit - for example code cm = cubic centimetres (ie millilitres), and code oz = (US) fluid ounces. For
     ...
     * fluid ounces. For use in ONIX 3.0 only
     * <p>
     * Jonix-Comment: Introduced in Onix3
     */
     ...
     * batteries if required. For use in ONIX 3.0 only
     * <p>
     * Jonix-Comment: Introduced in Onix3
     */
     ...
     * may be calculated from the number of batteries if required. For use in ONIX 3.0 only
     * <p>
     * Jonix-Comment: Introduced in Onix3
     */
     ...
     * 01, 02 and 03. For use in ONIX 3.0 only
     * <p>
     * Jonix-Comment: Introduced in Onix3
     */
     ...
     * be more convenient to handle. For use in ONIX 3.0 only
     * <p>
     * Jonix-Comment: Introduced in Onix3
     */
     ...
     * used only when the weight of individual copies (code 08) AND &lt;PackQuantity&gt; are supplied. For use in ONIX
     * 3.0 only
     * <p>
     * Jonix-Comment: Introduced in Onix3
     */
     ...
     * deliveries may be more convenient to handle. For use in ONIX 3.0 only
     * <p>
     * Jonix-Comment: Introduced in Onix3
     */
     ...
     * supplied. For use in ONIX 3.0 only
     * <p>
     * Jonix-Comment: Introduced in Onix3
     */
