...
public enum WebsiteRoles implements OnixCodelist, CodeList73 {
    ...
    /**
     * A webpage giving direct access to the content that is available via an online hosting service for a specified
     * product or resource. Generally used for content available online under subscription terms, for courseware etc
     */
