 ...
 * @see <a href=
 *      "https://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_70.html#codelist13">ONIX
 *      Codelist 13 in Reference Guide</a>
 */
public enum CollectionIdentifierTypes implements OnixCodelist, CodeList13 {
    /**
     * For example, publisher's own series ID scheme. Note that a distinctive &lt;IDTypeName&gt; is required with
     * proprietary identifiers
     */
    Proprietary_collection_ID_scheme("01", "Proprietary collection ID scheme"),
