 ...
 * @see <a href=
 *      "https://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_71.html#codelist44">ONIX
...
public enum NameIdentifierTypes implements OnixCodelist, CodeList44 {
    ...
    /**
     * Entertainment Identifier Registry party identifier (a DOI beginning '10.5237/' with a suffix of 8 hexadecimal
     * digits and one hyphen, and without the https://doi.org/ or the older http://dx.doi.org/), for example
     * '10.5237/C9F6-F41F' (Sam Raimi). See http://eidr.org
     */
     ...
     * '10.13039/100010269' (Wellcome Trust). Use of RORs for funder identifiers is now preferred. See
