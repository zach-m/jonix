 ...
 * @see <a href=
 *      "https://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_70.html#codelist61">ONIX
...
public enum PriceStatuss implements OnixCodelist, CodeList61 {
    ...
    public static PriceStatuss byCode(String code) {
    ...
    public static Optional<PriceStatuss> byCodeOptional(String code) {
