 ...
 * @see <a href=
 *      "https://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_63.html#codelist172">ONIX
...
public enum CurrencyZones implements OnixCodelist, CodeList172 {
    ...
    CurrencyZones(String code, String description) {
        this.code = code;
    ...
    public static Optional<CurrencyZones> byCodeOptional(String code) {
