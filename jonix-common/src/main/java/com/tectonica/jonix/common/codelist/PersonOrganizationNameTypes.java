 ...
 * @see <a href=
 *      "https://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_69.html#codelist18">ONIX
...
public enum PersonOrganizationNameTypes implements OnixCodelist, CodeList18 {
    ...
    /**
     * Use only within &lt;AlternativeName&gt; with a corporate name to indicate the name is an acronym, initialism or
    ...
    public static Optional<PersonOrganizationNameTypes> byCodeOptional(String code) {
