 ...
 * @see <a href=
 *      "https://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_36.html#codelist95">ONIX
...
public enum DefaultUnitOfWeights implements OnixCodelist, CodeList95 {
    ...
    public static DefaultUnitOfWeights byCode(String code) {
    ...
    public static Optional<DefaultUnitOfWeights> byCodeOptional(String code) {
