...
public enum SubjectSchemeIdentifiers implements OnixCodelist, CodeList27 {
    ...
    /**
     * Controlled vocabulary for educational objectives. See
     * https://www.bisg.org/products/recommendations-for-citing-educational-standards-and-objectives-in-metadata
     */
    ...
    /**
     * Used for tropes (recurring themes, motifs, patterns of behavior and/or character traits of the main character(s)
     * that run through a work) in German-speaking countries. Only for use in ONIX 3.0 or later. See
     * https://www.boersenverein.de/interessengruppen/ig-produktmetadaten/best-practices/
     * <p>
     * JONIX adds: Not included in Onix2
     */
    German_Tropes_list("D5", "German Tropes list");
    ...
    public static Optional<SubjectSchemeIdentifiers> byCodeOptional(String code) {
