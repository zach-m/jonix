 ...
 * @see <a href="http://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_32.html#codelist175">ONIX
 * Codelist 175 in Reference Guide</a>
 */
public enum ProductFormDetailsList175 implements OnixCodelist, CodeList175 {
    /**
     * CD 'red book' format
     */
    ...
    private ProductFormDetailsList175(String code, String description) {
        this.code = code;
