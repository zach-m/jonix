 ...
 * @see <a href="http://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_32.html#codelist15">ONIX Codelist 15 in Reference Guide</a>
 */
public enum TitleTypes implements OnixCodelist, CodeList15
{
    ...
    */
   Distinctive_title_book("01", "Distinctive title (book); Cover title (serial); Title on item (serial content item or reviewed resource)"), //
