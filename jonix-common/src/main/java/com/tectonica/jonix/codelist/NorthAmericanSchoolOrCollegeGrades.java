...
/**
 * marker interface to assist in IDE navigation to code-list 77 (North American school or college grade)
 */
 ...
 * @see <a href="http://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_32.html#codelist77">ONIX Codelist 77 in Reference Guide</a>
 */
public enum NorthAmericanSchoolOrCollegeGrades implements OnixCodelist, CodeList77
{
   ...
   private NorthAmericanSchoolOrCollegeGrades(String code, String description)
   {
      this.code = code;
