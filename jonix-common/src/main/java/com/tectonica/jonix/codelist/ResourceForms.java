...
/**
 * Enum that corresponds to ONIX's <b>CodeList161</b>
 * <p>
 * Resource form
 * 
...
public enum ResourceForms
{
	 ...
	 * Until Date specified in <ContentDate>). The ONIX recipient may embed the URL in a consumer facing-website (eg as
	 * the src attribute in an <img> link), and need not host an independent copy of the resource.
	 */
	 ...
	 * website. Special attention should be paid to the ‘Last Updated’ <ContentDate> to ensure the independent copy of
	 * the resource is kept up to date.
	 */
