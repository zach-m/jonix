 ...
 * @see <a href="http://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_32.html#codelist26">ONIX Codelist 26 in Reference Guide</a>
 */
public enum MainSubjectSchemeIdentifiers implements OnixCodelist, CodeList26
{
    ...
    */
   Statystyka_Ksi_ek_Papierowych_M_wionych_I_Elektronicznych("A3", "Statystyka Książek Papierowych, Mówionych I Elektronicznych"), //
   ...
   /**
    * International Standard Industry Classification, a classification of economic activities. Use for books that are about a particular industry or economic activity. See 'http://unstats.un.org/unsd/cr/registry/isic-4.asp'. &lt;SubjectCode&gt; should be a single letter denoting an ISIC section OR a 2-, 3- or 4-digit number denoting an ISIC division, group or class
    */
   ISIC("A7", "ISIC"), //
