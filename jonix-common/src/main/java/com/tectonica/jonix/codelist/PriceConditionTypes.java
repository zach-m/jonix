 ...
 * @see <a href="http://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_32.html#codelist167">ONIX Codelist 167 in Reference Guide</a>
 */
public enum PriceConditionTypes implements OnixCodelist, CodeList167
{
   ...
   /**
    * Upgrade to longer rental duration. &lt;PriceConditionQuantity&gt; gives minimum prior rental duration. Separate price condition with rental duration (code 10) specifies the new combined rental duration
    */
