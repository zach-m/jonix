...
/**
 * marker interface to assist in IDE navigation to code-list 216 (Velocity)
 */
 ...
 * @see <a href="http://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_32.html#codelist216">ONIX Codelist 216 in Reference Guide</a>
 */
public enum Velocitys implements OnixCodelist, CodeList216
{
   /**
   ...
   private Velocitys(String code, String description)
   {
      this.code = code;
