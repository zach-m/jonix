 ...
 * @see <a href="http://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_32.html#codelist28">ONIX Codelist 28 in Reference Guide</a>
 */
...
&lt;p&gt;NOTE: Introduced in Onix3
   ...
   private static volatile Map<String, Audiences> map;

   private static Map<String, Audiences> map()
   {
      Map<String, Audiences> result = map;
      if (result == null)
      {
