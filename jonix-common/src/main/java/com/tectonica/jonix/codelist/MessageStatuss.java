...
/**
 * marker interface to assist in IDE navigation to code-list 221 (Message status &lt;p&gt;NOTE: Introduced in Onix3)
 */
 ...
 * @see <a href="http://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_32.html#codelist221">ONIX
...
public enum MessageStatuss implements OnixCodelist, CodeList221 {
    ...
    private MessageStatuss(String code, String description) {
        this.code = code;
