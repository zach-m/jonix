 ...
 * @see <a href="http://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_32.html#codelist73">ONIX Codelist 73 in Reference Guide</a>
 */
public enum WebsiteRoles implements OnixCodelist, CodeList73
{
    ...
    */
   Other_publisher_s_website_relating_to_specified_contributor("08", "Other publisher’s website relating to specified contributor"), //
    ...
    */
   Contributor_s_own_website_for_group_or_series_of_works("13", "Contributor’s own website for group or series of works"), //

   /**
    * A publisher's webpage devoted to a group or series of works
    */
   Publisher_s_website_relating_to_group_or_series_of_works("14", "Publisher’s website relating to group or series of works"), //
    ...
    */
   Other_publisher_s_website_relating_to_group_or_series_of_works("15", "Other publisher’s website relating to group or series of works"), //
...
&lt;p&gt;NOTE: Introduced in Onix3
    */
   Publisher_s_or_third_party_website_for_permissions_requests("45", "Publisher’s or third party website for permissions requests");
