 ...
 * @see <a href="http://www.editeur.org/files/ONIX%20for%20books%20-%20code%20lists/ONIX_BookProduct_Codelists_Issue_32.html#codelist87">ONIX Codelist 87 in Reference Guide</a>
 */
public enum BibleReferenceLocations implements OnixCodelist, CodeList87
{
   ...
   private BibleReferenceLocations(String code, String description)
   {
      this.code = code;
