...
public class JonixAddresseeIdentifier implements JonixKeyedStruct<NameCodeTypes>, Serializable
{
   public static JonixAddresseeIdentifier EMPTY = new JonixAddresseeIdentifier();
   ...
   @Override
   public NameCodeTypes key() { return addresseeIDType; }
}
