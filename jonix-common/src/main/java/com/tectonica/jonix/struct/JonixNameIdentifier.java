...
public class JonixNameIdentifier implements JonixKeyedStruct<NameCodeTypes>, Serializable
{
   public static JonixNameIdentifier EMPTY = new JonixNameIdentifier();

   /**
    * the key of this struct (by which it can be looked up)
    */
   public NameCodeTypes nameIDType;
   ...
   @Override
   public NameCodeTypes key() { return nameIDType; }
}
