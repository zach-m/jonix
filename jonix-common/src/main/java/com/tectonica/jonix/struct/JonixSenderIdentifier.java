...
public class JonixSenderIdentifier implements JonixKeyedStruct<NameCodeTypes>, Serializable
{
    ...
    */
   public NameCodeTypes senderIDType;
   ...
   @Override
   public NameCodeTypes key() { return senderIDType; }
}
