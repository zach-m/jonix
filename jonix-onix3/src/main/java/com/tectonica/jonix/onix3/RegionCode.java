 ...
 * geographical terms, <i>eg</i> Northern Ireland, Australian Capital Territory. Note that US States have region codes,
 * while US overseas territories have distinct ISO Country Codes.
 * </p>
 * <table border='1' cellpadding='3'>
 * <tr>
 * <td>Format</td>
 * <td>Variable-length code, consisting of upper case letters with or without a hyphen. Suggested maximum length 8
 * characters</td>
 * </tr>
 * <tr>
 * <td>Codelist</td>
 ...
 * <tr>
 * <td>Example</td>
 * <td>&lt;RegionCode&gt;CA-NL&lt;/RegionCode&gt; (Newfoundland and Labrador)</td>
 * </tr>
 * </table>
 */
