 ...
 * specified within the Supplement manifest). The empty &lt;NoSupplement/&gt; must be used&nbsp;– and must only be
 * used&nbsp;– when no &lt;BodyManifest&gt; is present within the Supplement manifest.
 * </p>
