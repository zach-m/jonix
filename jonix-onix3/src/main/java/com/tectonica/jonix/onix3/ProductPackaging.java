 ...
 * <tr>
 * <td>Example</td>
 * <td>&lt;ProductPackaging&gt;05&lt;/ProductPackaging&gt; (Jewel case)</td>
 * </tr>
 * </table>
 */
public class ProductPackaging implements OnixElement, Serializable
{
	...
	public ProductPackaging(org.w3c.dom.Element element)
	{
		...
		value = ProductPackagingTypes.byValue(JPU.getContentAsString(element));
	}
}
