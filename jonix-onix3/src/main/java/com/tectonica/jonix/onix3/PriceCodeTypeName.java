 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;x477&gt;Retailer Inc. Ebook Tier Number&lt;/x477&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
...
public class PriceCodeTypeName implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of PriceCodeTypeName. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public static final PriceCodeTypeName EMPTY = new PriceCodeTypeName();

    public PriceCodeTypeName() {
        exists = false;
    }

    public PriceCodeTypeName(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<PriceCodeTypeName> action) {
        if (exists) {
            action.accept(this);
        }
    }
