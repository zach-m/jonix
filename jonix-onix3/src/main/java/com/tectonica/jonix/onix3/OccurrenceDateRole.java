 ...
 * {@link OccurrenceDate} ⯈ {@link OccurrenceDateRole}</li>
 * </ul>
 *
 * @since Onix-3.07
 */
public class OccurrenceDateRole implements OnixElement<EventOccurrenceDateRoles>, Serializable {
    ...
    public static final String refname = "OccurrenceDateRole";
    public static final String shortname = "x554";
    ...
    public EventOccurrenceDateRoles value;
    ...
    public static final OccurrenceDateRole EMPTY = new OccurrenceDateRole();

    public OccurrenceDateRole() {
        exists = false;
    }

    public OccurrenceDateRole(org.w3c.dom.Element element) {
        exists = true;
        datestamp = JPU.getAttribute(element, "datestamp");
        sourcename = JPU.getAttribute(element, "sourcename");
        sourcetype = RecordSourceTypes.byCode(JPU.getAttribute(element, "sourcetype"));

        value = EventOccurrenceDateRoles.byCode(JPU.getContentAsString(element));
    }

    /**
     * @return whether this tag (&lt;OccurrenceDateRole&gt; or &lt;x554&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<OccurrenceDateRole> action) {
        if (exists) {
            action.accept(this);
        }
    }
