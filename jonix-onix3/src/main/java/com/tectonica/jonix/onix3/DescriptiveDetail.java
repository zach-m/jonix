 ...
 *
 * Block 1, container for data describing the form and content of the product &#9679; Added &lt;Event&gt;, deprecated
 * &lt;Conference&gt; at revision 3.0.3 &#9679; Added &lt;EpubLicence&gt; at revision 3.0.2 &#9679; Modified cardinality
 * of &lt;ContributorStatement&gt;, &lt;EditionStatement&gt;, &lt;IllustrationsNote&gt;, &lt;AudienceDescription&gt; at
 * revision 3.0.1
 *
...
public class DescriptiveDetail implements OnixSuperComposite, Serializable {
     ...
     * included for full description of any multiple-item product.
     * </p>
     * JONIX adds: this field is required
     */
    ...
    private ListOfOnixComposite<ProductPart> productParts = JPU.emptyListOfOnixComposite(ProductPart.class);
     ...
     * each form contained within the product. The composite must be repeated for each item or component.
     * </p>
     * <p>
    ...
    private ListOfOnixComposite<Collection> collections = JPU.emptyListOfOnixComposite(Collection.class);

    /**
     * <p>
     * An optional group of data elements which carry attributes of a collection of which the product is part. The
     * composite is repeatable, to provide details when the product belongs to multiple collections.
     * </p>
     * JONIX adds: this list may be empty
     */
    ...
    private ListOfOnixComposite<Event> events = JPU.emptyListOfOnixComposite(Event.class);
    ...
    private ListOfOnixDataCompositeWithKey<AncillaryContent, JonixAncillaryContent,
        IllustrationAndOtherContentTypes> ancillaryContents =
            JPU.emptyListOfOnixDataCompositeWithKey(AncillaryContent.class);
     ...
     * which a product is intended. Optional, and repeatable if the product is intended for two or more groups.
