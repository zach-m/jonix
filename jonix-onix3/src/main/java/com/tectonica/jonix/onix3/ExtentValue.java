 ...
 * </table>
 * <p/>
 * Technical notes about &lt;ExtentValue&gt; from the schema author:
 *
 * Count of an extent of a product, using the method in &lt;ExtentType&gt; and the units in &lt;ExtentUnit&gt;
 *
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link Extent} ⯈ {@link ExtentValue}</li>
 * </ul>
 */
public class ExtentValue implements OnixElement<Double>, Serializable {
    ...
    public void ifExists(Consumer<ExtentValue> action) {
        if (exists) {
            action.accept(this);
        }
    }
