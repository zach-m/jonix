...
/**
 * <h1>Reprint detail</h1><p>Free text used to give details of the reprint history as part of the promotion of a book.
 * Optional, and repeatable if parallel text is provided in multiple languages. The <i>language</i> attribute is
 * optional for a single instance of &lt;ReprintDetail&gt;, but must be included in each instance if
 * &lt;ReprintDetail&gt; is repeated.</p><p>(For compatibility purposes, &lt;ReprintDetail&gt; is also repeatable –
 * without the <i>language</i> attribute, or with the same <i>language</i> attribute – to give information about
 * successive reprintings, but this is deprecated in favor of a single &lt;ReprintDetail&gt; instance [or a single
 * instance per language] and use of the XHTML &lt;dl&gt; list structure.)</p><table border='1'
 ...
 * name</td><td><tt>&lt;ReprintDetail&gt;</tt></td></tr><tr><td>Short tag</td><td><tt>&lt;k309&gt;</tt></td></tr><tr><td>Cardinality</td><td>0&#8230;n</td></tr><tr><td>Attributes</td><td>language,
 ...
 * <ul>
 * <li>ONIXMessage ⯈ Product ⯈ ProductSupply ⯈ MarketPublishingDetail ⯈ ReprintDetail</li>
 * </ul>
 */
