 ...
 * &lt;Prize&gt; composite, and repeatable to provide a parallel award name in multiple languages. The <i>language</i>
 * attribute is optional for a single instance of &lt;PrizeName&gt;, but must be included in each instance if
 * &lt;PrizeName&gt; is repeated.
 * </p>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link CollateralDetail} ⯈ {@link Prize} ⯈ {@link PrizeName}</li>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link Contributor} ⯈ {@link Prize} ⯈ {@link PrizeName}</li>
...
public class PrizeName implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of PrizeName. Could be null if {@code exists() == false}. Use {@link #value()} instead if
    ...
    public static final PrizeName EMPTY = new PrizeName();
    ...
    public void ifExists(Consumer<PrizeName> action) {
        if (exists) {
            action.accept(this);
        }
    }
