 ...
 * not specifically associated with a sales right within an occurrence of the &lt;SalesRights&gt; composite. Must be
 * preceded by at least one &lt;SalesRights&gt; composite. Optional, but required in all cases where no sales rights
