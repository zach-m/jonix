...
/**
 * <h1>Professional position</h1><p>A professional position held by a contributor to the product at the time of its
 * creation. Optional, and repeatable to provide parallel text in multiple languages. The <i>language</i> attribute is
 * optional for a single instance of &lt;ProfessionalPosition&gt;, but must be included in each instance if
