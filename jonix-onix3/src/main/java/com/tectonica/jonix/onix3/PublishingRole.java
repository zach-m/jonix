 ...
 * <p>
 * An ONIX code which identifies a role played by an entity in the publishing of a product. Mandatory in each occurrence
 * of the &lt;Publisher&gt; composite, and non-repeating.
 * </p>
 ...
 * 
 * <pre>
 * Role of an organization responsible for publishing the product, eg publisher or co-publisher, funder, printer
 * </pre>
 * 
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ContentDetail} ⯈ {@link ContentItem} ⯈ {@link Publisher} ⯈ {@link PublishingRole}</li>
