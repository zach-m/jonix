 ...
 * 
 * <pre>
 * Name or title of an end user license agreement
 ...
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link EpubLicenseWithDateType} ⯈ {@link EpubLicenseName}</li>
 ...
 * {@link EpubLicenseWithDateType} ⯈ {@link EpubLicenseName}</li>
 ...
 * {@link ResourceVersion} ⯈ {@link EpubLicenseWithDateType} ⯈ {@link EpubLicenseName}</li>
 ...
 * {@link SupportingResource} ⯈ {@link ResourceVersion} ⯈ {@link EpubLicenseWithDateType} ⯈ {@link EpubLicenseName}</li>
...
public class EpubLicenseName implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of EpubLicenseName. Could be null if {@code exists() == false}. Use {@link #value()}
    ...
    public void ifExists(Consumer<EpubLicenseName> action) {
        if (exists) {
            action.accept(this);
        }
    }
