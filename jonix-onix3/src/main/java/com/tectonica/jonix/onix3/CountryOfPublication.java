 ...
 * <tr>
 * <td>Format</td>
 * <td>Fixed length, two letters, based on IO 3166-1. Note that ISO 3166-1 specifies that country codes shall be sent as
 * upper case only</td>
 * </tr>
 * <tr>
 * <td>Codelist</td>
 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;b083&gt;US&lt;/b083&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 * Technical notes about &lt;CountryOfPublication&gt; from the schema author:
 *
 * Country in which the publisher is based
 *
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link PublishingDetail} ⯈ {@link CountryOfPublication}</li>
 * </ul>
 */
public class CountryOfPublication implements OnixElement<Countrys>, Serializable {
    ...
    public void ifExists(Consumer<CountryOfPublication> action) {
        if (exists) {
            action.accept(this);
        }
    }
