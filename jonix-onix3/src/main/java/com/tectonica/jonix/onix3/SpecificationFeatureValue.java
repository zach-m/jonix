 ...
 * </table>
 * <p/>
 * Technical notes about &lt;SpecificationFeatureValue&gt; from the schema author:
 *
 * Controlled value specifying or describing a specification feature &#9679; Added at revision 3.0.8
 *
 ...
 * {@link SpecificationFeature} ⯈ {@link SpecificationFeatureValue}</li>
 * <li>{@link Product} ⯈ {@link ProductionDetail} ⯈ {@link ProductionManifest} ⯈ {@link SupplementManifest} ⯈
...
public class SpecificationFeatureValue implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<SpecificationFeatureValue> action) {
        if (exists) {
            action.accept(this);
        }
    }
