 ...
 * <p>
 * A text field giving the e‑mail address for a contact person within the sender organization who is responsible for the
 * content of the message as a whole. Optional and non-repeating.
 * </p>
 ...
 * <li>{@link Header} ⯈ {@link Sender} ⯈ {@link EmailAddress}</li>
 * <li>{@link Product} ⯈ {@link ProductSupply} ⯈ {@link SupplyDetail} ⯈ {@link NewSupplier} ⯈ {@link EmailAddress}</li>
 * <li>{@link Product} ⯈ {@link PublishingDetail} ⯈ {@link ProductContact} ⯈ {@link EmailAddress}</li>
 * <li>{@link Product} ⯈ {@link ProductSupply} ⯈ {@link MarketPublishingDetail} ⯈ {@link ProductContact} ⯈
 * {@link EmailAddress}</li>
 * <li>{@link Product} ⯈ {@link ProductSupply} ⯈ {@link SupplyDetail} ⯈ {@link Supplier} ⯈ {@link EmailAddress}</li>
 * <li>{@link Header} ⯈ {@link Addressee} ⯈ {@link EmailAddress}</li>
...
public class EmailAddress implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<EmailAddress> action) {
        if (exists) {
            action.accept(this);
        }
    }
