 ...
 * {@link Rating}</li>
 * <li>{@link Product} ⯈ {@link CollateralDetail} ⯈ {@link TextContent} ⯈ {@link ReviewRating} ⯈ {@link Rating}</li>
 * <li>{@link Product} ⯈ {@link ContentDetail} ⯈ {@link ContentItem} ⯈ {@link CitedContent} ⯈ {@link ReviewRating} ⯈
 * {@link Rating}</li>
 * <li>{@link Product} ⯈ {@link CollateralDetail} ⯈ {@link CitedContent} ⯈ {@link ReviewRating} ⯈ {@link Rating}</li>
 * </ul>
 *
 * @since Onix-3.03
 */
public class Rating implements OnixElement<Double>, Serializable {
    ...
    public void ifExists(Consumer<Rating> action) {
        if (exists) {
            action.accept(this);
        }
    }
