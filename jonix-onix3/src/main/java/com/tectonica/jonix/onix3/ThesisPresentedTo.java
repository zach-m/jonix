 ...
 * </table>
 * <p/>
 * Technical notes about &lt;ThesisPresentedTo&gt; from the schema author:
 *
 * Name of academic institution to which a thesis was presented
 *
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link ThesisPresentedTo}</li>
 * </ul>
 */
public class ThesisPresentedTo implements OnixElement<String>, Serializable {
    ...
    public static final ThesisPresentedTo EMPTY = new ThesisPresentedTo();
    ...
    public void ifExists(Consumer<ThesisPresentedTo> action) {
        if (exists) {
            action.accept(this);
        }
    }
