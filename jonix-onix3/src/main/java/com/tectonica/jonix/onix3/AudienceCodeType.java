 ...
 * <tr>
 * <td>Example</td>
 * <td>&lt;AudienceCodeType&gt;02&lt;/AudienceCodeType&gt; (Proprietary)</td>
 * </tr>
 * </table>
 */
public class AudienceCodeType implements OnixElement, Serializable
{
	...
	public AudienceCodeType(org.w3c.dom.Element element)
	{
		...
		value = AudienceCodeTypes.byValue(JPU.getContentAsString(element));
	}
}
