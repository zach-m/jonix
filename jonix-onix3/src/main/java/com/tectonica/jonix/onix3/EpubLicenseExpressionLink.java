 ...
 * {@link EpubLicenseExpressionLink}</li>
 ...
 * {@link EpubLicenseWithDateType} ⯈ {@link EpubLicenseExpression} ⯈ {@link EpubLicenseExpressionLink}</li>
...
public class EpubLicenseExpressionLink implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<EpubLicenseExpressionLink> action) {
        if (exists) {
            action.accept(this);
        }
    }
