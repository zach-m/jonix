 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;SenderName&gt;HarperCollins
 * London&lt;/SenderName&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link ONIXMessage} ⯈ {@link Header} ⯈ {@link Sender} ⯈ {@link SenderName}</li>
 * </ul>
 */
public class SenderName implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of SenderName. Could be null if {@code exists == false}. Use {@link #value()} instead if
