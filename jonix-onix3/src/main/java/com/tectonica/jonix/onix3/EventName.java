 ...
 * languages (<i>eg</i>&nbsp;‘United Nations Climate Change Conference’ and <span lang="fr">«&nbsp;Conférences des
 * Nations unies sur les changements climatiques&nbsp;»</span>). The <i>language</i> attribute is optional for a single
 * instance of &lt;EventName&gt;, but must be included in each instance if &lt;EventName&gt; is repeated.
 * </p>
 ...
 * </table>
 * <p/>
 * Technical notes about &lt;EventName&gt; from the schema author:
 *
 * Name of an event or an occurrence of an event which the product is about &#9679; Added at revision 3.0.3
 *
