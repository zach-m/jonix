 ...
 * </table>
 * <p/>
 * Technical notes about &lt;TitlesAfterNames&gt; from the schema author:
 *
 * Part of a structured name (of a person or persona) - titles after the names, eg 'Duke of Edinburgh' &#9679; Added
 ...
 * {@link AlternativeName} ⯈ {@link TitlesAfterNames}</li>
 ...
 * {@link TitlesAfterNames}</li>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link Contributor} ⯈ {@link TitlesAfterNames}</li>
 ...
 * {@link TitlesAfterNames}</li>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link NameAsSubject} ⯈ {@link TitlesAfterNames}</li>
...
public class TitlesAfterNames implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of TitlesAfterNames. Could be null if {@code exists() == false}. Use {@link #value()}
