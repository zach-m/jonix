 ...
 * their typographical layout in a printed table of contents). &lt;LevelSequenceNumber&gt; is <em>not</em> a required
 * field, but it is strongly recommended for structured tables of contents. If used, it must occur once and only once in
 * each occurrence of the &lt;ContentItem&gt; composite.</p><table border='1' cellpadding='3'><tr><td>Format</td><td>Variable-length
 ...
 * tag</td><td>&lt;b284&gt;</td></tr><tr><td>Cardinality</td><td>0&#8230;1</td></tr><tr><td>Example</td><td>&lt;LevelSequenceNumber&gt;2.24.1.7&lt;/LevelSequenceNumber&gt;</td></tr></table>
 */
public class LevelSequenceNumber implements OnixElement<String>, Serializable {
     ...
     * maximum length 100 characters<p> (type: dt.MultiLevelNumber)
     */
    public String value;
