 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;PackQuantity&gt;24&lt;/PackQuantity&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ProductSupply} ⯈ {@link SupplyDetail} ⯈ {@link PackQuantity}</li>
 * </ul>
 */
public class PackQuantity implements OnixElement<Integer>, Serializable {
    ...
    /**
     * This is the raw content of PackQuantity. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public static final PackQuantity EMPTY = new PackQuantity();
    ...
    public void ifExists(Consumer<PackQuantity> action) {
        if (exists) {
            action.accept(this);
        }
    }
