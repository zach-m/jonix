 ...
 * </table>
 * <p/>
 * Technical notes about &lt;EventTheme&gt; from the schema author:
 * 
 * <pre>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link Event} ⯈ {@link EventTheme}</li>
 * </ul>
 *
 * @since Onix-3.03
 */
public class EventTheme implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of EventTheme. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public void ifExists(Consumer<EventTheme> action) {
        if (exists) {
            action.accept(this);
        }
    }
