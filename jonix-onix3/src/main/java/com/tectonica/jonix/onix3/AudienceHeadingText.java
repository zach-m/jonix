 ...
 *
 * Textual heading from proprietary audience code scheme &#9679; Added at revision 3.0.8
 *
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link Audience} ⯈ {@link AudienceHeadingText}</li>
 * </ul>
 *
 * @since Onix-3.08
 */
public class AudienceHeadingText implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<AudienceHeadingText> action) {
        if (exists) {
            action.accept(this);
        }
    }
