 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ProductSupply} ⯈ {@link SupplyDetail} ⯈ {@link OrderQuantityMultiple}</li>
 * </ul>
 *
 * @since Onix-3.03
 */
public class OrderQuantityMultiple implements OnixElement<Integer>, Serializable {
    ...
    /**
     * This is the raw content of OrderQuantityMultiple. Could be null if {@code exists() == false}. Use
    ...
    public void ifExists(Consumer<OrderQuantityMultiple> action) {
        if (exists) {
            action.accept(this);
        }
    }
