 ...
 * the 24-hour clock, with an explicit indication of the time zone if required, in a format based on ISO 8601. Mandatory
 * and non-repeating.</p><table border='1' cellpadding='3'><tr><td>Format</td><td>Permitted formats, where 'T' and 'Z'
 * represent themselves (ie the letters T and Z), and where the symbol '&#177;' represents either '+' or '-' to indicate
 * a timezone offset from UTC. YYYYMMDD Date only YYYYMMDDThhmm Date and time (local time of sender) YYYYMMDDThhmmZ
...
public class SentDateTime implements OnixElement<String>, Serializable {
     ...
     * seconds) &#8224; indicates the preferred formats<p> (type: dt.DateOrDateTime)
     */
    public String value;
