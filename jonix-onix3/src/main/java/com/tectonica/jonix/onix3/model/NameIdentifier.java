...
public class NameIdentifier
{
	...
	public static NameIdentifier fromDoc(org.w3c.dom.Element element)
	{
		final NameIdentifier x = new NameIdentifier();
		...
		DU.forElementsOf(element, new DU.ElementListener()
		{
			...
			public void onElement(org.w3c.dom.Element element)
			{
				...
				if (name.equalsIgnoreCase(NameIDType.refname) || name.equalsIgnoreCase(NameIDType.shortname))
					x.nameIDType = NameIDType.fromDoc(element);
