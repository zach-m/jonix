 ...
 * </table>
 * <p/>
 * Technical notes about &lt;CountriesIncluded&gt; from the schema author:
 *
 * List of countries included in a territory (subject to any regions excluded)
 *
...
public class CountriesIncluded implements OnixElement<java.util.Set<Countrys>>, Serializable {
    ...
    public void ifExists(Consumer<CountriesIncluded> action) {
        if (exists) {
            action.accept(this);
        }
    }
