 ...
 * types (<i>eg</i>&nbsp;text, audio, video) is the primary type for the product&nbsp;– but use with physical products
 * is not precluded. Further content types may be specified in the &lt;ProductContentType&gt;. Optional and
 * non-repeating.
 * </p>
