...
public class ReligiousTextFeatureDescription
{
	...
	public static ReligiousTextFeatureDescription fromDoc(org.w3c.dom.Element element)
	{
		final ReligiousTextFeatureDescription x = new ReligiousTextFeatureDescription();
