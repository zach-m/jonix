 ...
 * <tr>
 * <td>Format</td>
 * <td>Variable length text, suggested maximum 100 characters. XHTML is enabled in this element - see Using XHTML,
 * multilingual text, HTML, XML, JSON</td>
 * </tr>
 * <tr>
 ...
 * {@link ReligiousTextFeatureDescription}</li>
 * </ul>
 */
public class ReligiousTextFeatureDescription implements OnixElement<String>, Serializable {
     ...
     * XHTML, multilingual text, HTML, XML, JSON
     * <p>
     * (type: XHTML)
     */
    public String value;
    ...
    public void ifExists(Consumer<ReligiousTextFeatureDescription> action) {
        if (exists) {
            action.accept(this);
        }
    }
