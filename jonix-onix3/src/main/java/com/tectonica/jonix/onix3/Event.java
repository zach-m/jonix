 ...
 *
 * Details of an event (eg conference, exhibition, sporting event) to which the product is related &#9679; Added at
 * revision 3.0.3
 *
...
public class Event implements OnixSuperComposite, Serializable {
     ...
     * multiple languages (<i>eg</i>&nbsp;‘United Nations Climate Change Conference’ and «&nbsp;Conférences des Nations
