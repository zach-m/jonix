 ...
 * </table>
 * <p/>
 * Technical notes about &lt;CountryCode&gt; from the schema author:
 *
 * A single country, eg one with which a contributor is associated, or from which a language variant is derived
 *
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ProductSupply} ⯈ {@link SupplyDetail} ⯈ {@link SupplyContact} ⯈ {@link CountryCode}</li>
 ...
 * ⯈ {@link CountryCode}</li>
 * <li>{@link Product} ⯈ {@link PublishingDetail} ⯈ {@link ProductContact} ⯈ {@link CountryCode}</li>
