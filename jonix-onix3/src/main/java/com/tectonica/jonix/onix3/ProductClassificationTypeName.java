 ...
 * which there is no individual scheme type code). Must be included when, and only when, the code in the
 ...
 *
 * Name of a proprietary trade classification scheme (which does not have its own code) used to classify the product for
 * national or international trade purposes &#9679; Added at revision 3.0.7
 *
...
public class ProductClassificationTypeName implements OnixElement<String>, Serializable {
    ...
    public static final String refname = "ProductClassificationTypeName";
    public static final String shortname = "x555";
    ...
    public static final ProductClassificationTypeName EMPTY = new ProductClassificationTypeName();

    public ProductClassificationTypeName() {
        exists = false;
    }

    public ProductClassificationTypeName(org.w3c.dom.Element element) {
        exists = true;
    ...
    /**
     * @return whether this tag (&lt;ProductClassificationTypeName&gt; or &lt;x555&gt;) is explicitly provided in the
     *         ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<ProductClassificationTypeName> action) {
        if (exists) {
            action.accept(this);
        }
    }
