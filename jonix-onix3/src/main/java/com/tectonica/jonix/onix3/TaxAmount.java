 ...
 *
 * Amount of tax levied on the &lt;TaxableAmount&gt; and included in the &lt;PriceAmount&gt; -&#160;in effect, the tax
 * added to the price before tax
 *
...
public class TaxAmount implements OnixElement<Double>, Serializable {
    ...
    public void ifExists(Consumer<TaxAmount> action) {
        if (exists) {
            action.accept(this);
        }
    }
