 ...
 * </table>
 * <p/>
 * Technical notes about &lt;NamesAfterKey&gt; from the schema author:
 *
 * Part of a structured name (of a person or persona) - given names that follow the key names &#9679; Added language
 ...
 * {@link AlternativeName} ⯈ {@link NamesAfterKey}</li>
 ...
 * {@link NamesAfterKey}</li>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link Contributor} ⯈ {@link NamesAfterKey}</li>
 * <li>{@link Product} ⯈ {@link ContentDetail} ⯈ {@link ContentItem} ⯈ {@link Contributor} ⯈ {@link NamesAfterKey}</li>
 * <li>{@link Product} ⯈ {@link PromotionDetail} ⯈ {@link PromotionalEvent} ⯈ {@link Contributor} ⯈
 * {@link NamesAfterKey}</li>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link Collection} ⯈ {@link Contributor} ⯈
 * {@link NamesAfterKey}</li>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link NameAsSubject} ⯈ {@link NamesAfterKey}</li>
