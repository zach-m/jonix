 ...
 *
 * Monotonic sequence number used if an ONIX message with a particular message number needs to be re-sent (the original
 * is 1, the first repeat is 2)
 *
...
public class MessageRepeat implements OnixElement<Integer>, Serializable {
    ...
    public static final String refname = "MessageRepeat";
    public static final String shortname = "m181";
    ...
    public static final MessageRepeat EMPTY = new MessageRepeat();

    public MessageRepeat() {
        exists = false;
    }

    public MessageRepeat(org.w3c.dom.Element element) {
        exists = true;
    ...
    /**
     * @return whether this tag (&lt;MessageRepeat&gt; or &lt;m181&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<MessageRepeat> action) {
        if (exists) {
            action.accept(this);
        }
    }
