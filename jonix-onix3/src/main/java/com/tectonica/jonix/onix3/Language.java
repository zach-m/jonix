...
public class Language implements OnixDataCompositeWithKey<JonixLanguage, LanguageRoles>, Serializable {
     ...
     * Brazilian Portuguese, Canadian French. Optional and non-repeating.
     * </p>
     ...
     * Dutch as used in the Flemish region of Belgium, or the specific Québécois variety of Canadian French. Optional
     * and non-repeatable. A region is an area which is not a country (in the sense that it does not have a distinct
     * country code), but which is precisely defined in geographical terms, <i>eg</i>&nbsp;Quebec, Scotland. In general,
     * if a region is specified, the country may be omitted. If both country and region are specified, the region must
     * be within the country. Note that US States have region codes, while US overseas territories have distinct ISO
     * Country Codes.
     * </p>
     * JONIX adds: this field is optional
     */
