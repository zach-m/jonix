...
/**
 * <h1>Language composite</h1><p>A group of data elements which together represent a language, and specify its role and,
 * where required, whether it is a country variant. Optional, and repeatable to specify multiple languages and their
 * various roles.</p><table border='1' cellpadding='3'><tr><td>Reference name</td><td><tt>&lt;Language&gt;</tt></td></tr><tr><td>Short
 * tag</td><td><tt>&lt;language&gt;</tt></td></tr><tr><td>Cardinality</td><td>0&#8230;n</td></tr></table>
 * <p>&nbsp;</p>
 ...
 * <ul>
 * <li>ONIXMessage ⯈ Product ⯈ DescriptiveDetail ⯈ Language</li>
 * <li>ONIXMessage ⯈ Product ⯈ ContentDetail ⯈ ContentItem ⯈ Language</li>
 * </ul>
 */
public class Language implements OnixDataCompositeWithKey<JonixLanguage, LanguageRoles>, Serializable {
    ...
    /**
     * <p>A code identifying the country when this specifies a variant of the language, <i>eg</i> US English. Optional
     * and non-repeating.</p>
    ...
    /**
     * <p>A code identifying the script in which the language is represented. Optional and non-repeating.</p>
     * Jonix-Comment: this field is optional
     */
