 ...
 * </table>
 * <p/>
 * Technical notes about &lt;FundingIDType&gt; from the schema author:
 *
 * Type of identifier for a particular tranche of funding &#9679; Added at revision 3.0.3
 *
...
public class FundingIDType implements OnixElement<GrantIdentifierTypes>, Serializable {
    ...
    public void ifExists(Consumer<FundingIDType> action) {
        if (exists) {
            action.accept(this);
        }
    }
