...
/**
 * <h1>Citation note</h1><p>A free text note giving any additional information about cited content, for example a
 * detailed volume, issue and page reference to content cited from a periodical. Optional, and repeatable when parallel
