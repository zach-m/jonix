 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link Measure} ⯈ {@link Measurement}</li>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link ProductPart} ⯈ {@link Measure} ⯈ {@link Measurement}</li>
 * <li>{@link Product} ⯈ {@link ProductionDetail} ⯈ {@link ProductionManifest} ⯈ {@link SupplementManifest} ⯈
 * {@link Measure} ⯈ {@link Measurement}</li>
 * </ul>
 */
public class Measurement implements OnixElement<Double>, Serializable {
    ...
    public void ifExists(Consumer<Measurement> action) {
        if (exists) {
            action.accept(this);
        }
    }
