 ...
 *
 * The number of copies on each pallet currently held in stock by the supplier &#9679; Added at revision 3.0.5
 *
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ProductSupply} ⯈ {@link SupplyDetail} ⯈ {@link PalletQuantity}</li>
 * </ul>
 *
 * @since Onix-3.05
 */
public class PalletQuantity implements OnixElement<Integer>, Serializable {
    ...
    public void ifExists(Consumer<PalletQuantity> action) {
        if (exists) {
            action.accept(this);
        }
    }
