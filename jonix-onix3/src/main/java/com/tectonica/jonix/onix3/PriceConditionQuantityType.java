...
/**
 * <h1>Price condition quantity type</h1><p>An ONIX code identifying a type of price condition quantity. Mandatory in each occurrence of the &lt;PriceConditionQuantity&gt; composite, and non-repeating.</p><table border='1' cellpadding='3'><tr><td>Format</td><td>Fixed length, two digits</td></tr><tr><td>Codelist</td><td>List 168</td></tr><tr><td>Reference name</td><td><tt>&lt;PriceConditionQuantityType&gt;</tt></td></tr><tr><td>Short tag</td><td><tt>&lt;x464&gt;</tt></td></tr><tr><td>Cardinality</td><td>1</td></tr><tr><td>Example</td><td><tt>&lt;x464&gt;01&lt;/x464&gt;</tt> (Time period)</td></tr></table>
 * <p>&nbsp;</p>
 ...
 * <ul>
 * <li>ONIXMessage ⯈ Product ⯈ ProductSupply ⯈ SupplyDetail ⯈ Reissue ⯈ Price ⯈ PriceCondition ⯈ PriceConditionQuantity ⯈ PriceConditionQuantityType</li>
 * <li>ONIXMessage ⯈ Product ⯈ ProductSupply ⯈ SupplyDetail ⯈ Price ⯈ PriceCondition ⯈ PriceConditionQuantity ⯈ PriceConditionQuantityType</li>
 * </ul>
 */
public class PriceConditionQuantityType implements OnixElement<PriceConditionQuantityTypes>, Serializable
{
   ...
   */
   ...
   /**
    * @return whether this tag (&lt;PriceConditionQuantityType&gt; or &lt;x464&gt;) is explicitly provided in the ONIX XML
    */
   @Override
