 ...
 * <li>{@link Product} ⯈ {@link CollateralDetail} ⯈ {@link TextContent} ⯈ {@link ContentDate} ⯈
 * {@link ContentDateRole}</li>
 * <li>{@link Product} ⯈ {@link ContentDetail} ⯈ {@link ContentItem} ⯈ {@link CitedContent} ⯈ {@link ContentDate} ⯈
 * {@link ContentDateRole}</li>
 * <li>{@link Product} ⯈ {@link CollateralDetail} ⯈ {@link CitedContent} ⯈ {@link ContentDate} ⯈
 * {@link ContentDateRole}</li>
...
public class ContentDateRole implements OnixElement<ContentDateRoles>, Serializable {
    ...
    public void ifExists(Consumer<ContentDateRole> action) {
        if (exists) {
            action.accept(this);
        }
    }
