...
import com.tectonica.jonix.codelist.TextItemIdentifierTypeCodes;
...
public class TextItemIdentifier
{
	...
	public TextItemIDType textItemIDType; // Required
	public IDTypeName idTypeName; // Optional
	public IDValue idValue; // Required

	public static TextItemIdentifier fromDoc(org.w3c.dom.Element element)
	{
		final TextItemIdentifier x = new TextItemIdentifier();
		...
		DU.forElementsOf(element, new DU.ElementListener()
		{
			...
			public void onElement(org.w3c.dom.Element element)
			{
				...
				if (name.equals(TextItemIDType.refname) || name.equals(TextItemIDType.shortname))
					x.textItemIDType = TextItemIDType.fromDoc(element);
	...
	public TextItemIdentifierTypeCodes getTextItemIDTypeValue()
	{
