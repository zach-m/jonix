 ...
 * </table>
 * <p/>
 * Technical notes about &lt;SupplierCodeType&gt; from the schema author:
 *
 * Type of proprietary code scheme (as defined by the supplier)
 *
...
public class SupplierCodeType implements OnixElement<SupplierOwnCodeTypes>, Serializable {
    ...
    public void ifExists(Consumer<SupplierCodeType> action) {
        if (exists) {
            action.accept(this);
        }
    }
