 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ContentDetail} ⯈ {@link ContentItem} ⯈ {@link CitedContent} ⯈ {@link ListName}</li>
 * <li>{@link Product} ⯈ {@link CollateralDetail} ⯈ {@link CitedContent} ⯈ {@link ListName}</li>
 * </ul>
 */
public class ListName implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of ListName. Could be null if {@code exists() == false}. Use {@link #value()} instead if
    ...
    public static final ListName EMPTY = new ListName();
    ...
    public void ifExists(Consumer<ListName> action) {
        if (exists) {
            action.accept(this);
        }
    }
