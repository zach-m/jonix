 ...
 * <tr>
 * <td>Example</td>
 * <td>&lt;SupplyDateRole&gt;02&lt;/SupplyDateRole&gt; (Embargo date)</td>
 * </tr>
 * </table>
 */
public class SupplyDateRole implements OnixElement, Serializable
{
	...
	public SupplyDateRole(org.w3c.dom.Element element)
	{
		...
		value = SupplyDateRoles.byValue(JPU.getContentAsString(element));
	}
}
