...
public class AddresseeIdentifier implements Serializable
{
	...
	public AddresseeIdentifierStruct asStruct()
	{
		AddresseeIdentifierStruct x = new AddresseeIdentifierStruct();
