 ...
 * 
 * <pre>
 * Type of dentifier for the name of a person, persona or corporate identity, eg an ISNI or ORCID, or the publisher's proprietary internal identifier
 * </pre>
 * 
...
public class NameIDType implements OnixElement<NameIdentifierTypes>, Serializable {
    ...
    public void ifExists(Consumer<NameIDType> action) {
        if (exists) {
            action.accept(this);
        }
    }
