...
import com.tectonica.jonix.common.codelist.CitedContentTypes;
 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;CitedContentType&gt;01&lt;/CitedContentType&gt;</tt> (Full text of review)</td>
 * </tr>
 * </table>
 * <p/>
 * Technical notes about &lt;CitedContentType&gt; from the schema author:
 *
 * Type of third-party material cited
 *
 ...
 * {@link CitedContentType}</li>
 * <li>{@link Product} ⯈ {@link CollateralDetail} ⯈ {@link CitedContent} ⯈ {@link CitedContentType}</li>
 * </ul>
 */
public class CitedContentType implements OnixElement<CitedContentTypes>, Serializable {
    ...
    /**
     * @return whether this tag (&lt;CitedContentType&gt; or &lt;x430&gt;) is explicitly provided in the ONIX XML
     */
    @Override
    ...
    public void ifExists(Consumer<CitedContentType> action) {
        if (exists) {
            action.accept(this);
        }
    }
