 ...
 * <tr>
 * <td>Example</td>
 * <td><tt>&lt;CopiesSold&gt;6400 copies sold of this edition in hardback&lt;/CopiesSold&gt;</tt></td>
 * </tr>
 * </table>
 * <p/>
 ...
 * <ul>
 * <li>{@link Product} ⯈ {@link ProductSupply} ⯈ {@link MarketPublishingDetail} ⯈ {@link CopiesSold}</li>
 * </ul>
 */
public class CopiesSold implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of CopiesSold. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public void ifExists(Consumer<CopiesSold> action) {
        if (exists) {
            action.accept(this);
        }
    }
