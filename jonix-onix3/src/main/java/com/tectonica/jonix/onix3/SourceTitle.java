 ...
 * <li>{@link Product} ⯈ {@link CollateralDetail} ⯈ {@link TextContent} ⯈ {@link SourceTitle}</li>
 * <li>{@link Product} ⯈ {@link ContentDetail} ⯈ {@link ContentItem} ⯈ {@link CitedContent} ⯈ {@link SourceTitle}</li>
 * <li>{@link Product} ⯈ {@link CollateralDetail} ⯈ {@link CitedContent} ⯈ {@link SourceTitle}</li>
 * </ul>
 */
public class SourceTitle implements OnixElement<String>, Serializable {
    ...
    /**
     * This is the raw content of SourceTitle. Could be null if {@code exists() == false}. Use {@link #value()} instead
    ...
    public static final SourceTitle EMPTY = new SourceTitle();

    public SourceTitle() {
        exists = false;
    }

    public SourceTitle(org.w3c.dom.Element element) {
        exists = true;
    ...
    public void ifExists(Consumer<SourceTitle> action) {
        if (exists) {
            action.accept(this);
        }
    }
