...
/**
 * <h1>Territory composite</h1><p>A group of data elements which together define a territory for which the text in the
 * &lt;Text&gt; element is specifically intended. Optional in each occurrence of the &lt;TextContent&gt; composite, and
 * non-repeating. If omitted, the text is intended for use wherever the product may be sold (see <a
 * href="#onixmessage_product_publishingdetail_p21">Group&nbsp;P.21</a>). If included, the text should be used by
 * recipients in the specified territory in preference to any text that lacks a specified territory.</p><p>Care should
 * be taken to avoid ambiguities (for example two different ‘short descriptions’ – without <i>language</i> attributes or
 * with the same <i>language</i> attribute – marked for use in the same country or region), and to ensure that
 * appropriate descriptions and supporting text are supplied for all countries and regions where the product may be
 ...
 * composites are intended for use only where no appropriate targeted text is present.</p><table border='1'
 * cellpadding='3'><tr><td>Reference name</td><td><tt>&lt;Territory&gt;</tt></td></tr><tr><td>Short
 * tag</td><td><tt>&lt;territory&gt;</tt></td></tr><tr><td>Cardinality</td><td>0&#8230;1</td></tr></table>
 * <p>&nbsp;</p>
...
public class Territory implements OnixDataComposite<JonixTerritory>, Serializable {
    ...
    /**
     * <p>One or more ISO standard codes identifying countries included in the territory. Successive codes must be
     * separated by spaces. Optional and non-repeating, but either &lt;CountriesIncluded&gt; or &lt;RegionsIncluded&gt;
     * is mandatory in each occurrence of the &lt;Territory&gt; composite.</p>
    ...
    /**
     * <p>One or more ONIX codes identifying regions included in the territory. A region is an area which is not a
     * country, but which is precisely defined in geographical terms, <i>eg</i> World, Northern Ireland, Australian
     * Capital Territory. Successive codes must be separated by spaces. Optional and non-repeating, but either
    ...
    /**
     * <p>One or more ONIX codes identifying regions excluded from the territory. Successive codes must be separated by
     ...
     * includes a supra-national region code (such as ‘World’).</p>
     * Jonix-Comment: this field is optional
     */
    ...
    /**
     * <p>One or more ISO standard codes identifying countries excluded from the territory. Successive codes must be
     * separated by spaces. Optional and non-repeating, and can only occur if the &lt;RegionsIncluded&gt; element is
     * also present and includes a supra-national region code (such as ‘World’).</p>
     * Jonix-Comment: this field is optional
     */
