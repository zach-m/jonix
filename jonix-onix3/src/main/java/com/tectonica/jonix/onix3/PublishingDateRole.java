...
/**
 * <h1>Publishing date role code</h1><p>An ONIX code indicating the significance of the date, <i>eg</i> pubdate,
 * announcement date, latest reprint date. Mandatory in each occurrence of the &lt;PublishingDate&gt; composite, and
