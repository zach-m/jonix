 ...
 * product was affiliated <em>at the time of its creation</em>, and&nbsp;– if the &lt;ProfessionalPosition&gt; element
 * is also present&nbsp;– where the contributor held that position. Optional, and repeatable to specify organization
