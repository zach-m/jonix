 ...
 * {@link CoverResource} ⯈ {@link ResourceFileLink}</li>
 * <li>{@link Product} ⯈ {@link ProductionDetail} ⯈ {@link ProductionManifest} ⯈ {@link SupplementManifest} ⯈
 ...
 * {@link BodyResource} ⯈ {@link ResourceFileLink}</li>
 * <li>{@link Product} ⯈ {@link ProductionDetail} ⯈ {@link ProductionManifest} ⯈ {@link SupplementManifest} ⯈
 ...
 * {@link InsertResource} ⯈ {@link ResourceFileLink}</li>
 * </ul>
 *
 * @since Onix-3.08
 */
public class ResourceFileLink implements OnixElement<String>, Serializable {
    ...
    public void ifExists(Consumer<ResourceFileLink> action) {
        if (exists) {
            action.accept(this);
        }
    }
