...
/**
 * <h1>Subject scheme identifier</h1><p>An ONIX code which identifies the category scheme which is used in an occurrence
 * of the &lt;Subject&gt; composite. Mandatory in each occurrence of the composite, and non-repeating.</p><p>For
