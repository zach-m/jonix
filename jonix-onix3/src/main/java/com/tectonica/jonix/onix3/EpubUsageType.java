 ...
 * {@link ResourceVersion} ⯈ {@link EpubUsageConstraint} ⯈ {@link EpubUsageType}</li>
 * <li>{@link Product} ⯈ {@link CollateralDetail} ⯈ {@link SupportingResource} ⯈ {@link ResourceVersion} ⯈
 * {@link EpubUsageConstraint} ⯈ {@link EpubUsageType}</li>
 * <li>{@link Product} ⯈ {@link PromotionDetail} ⯈ {@link PromotionalEvent} ⯈ {@link EventOccurrence} ⯈
 * {@link SupportingResource} ⯈ {@link ResourceVersion} ⯈ {@link EpubUsageConstraint} ⯈ {@link EpubUsageType}</li>
...
public class EpubUsageType implements OnixElement<UsageTypes>, Serializable {
    ...
    public void ifExists(Consumer<EpubUsageType> action) {
        if (exists) {
            action.accept(this);
        }
    }
