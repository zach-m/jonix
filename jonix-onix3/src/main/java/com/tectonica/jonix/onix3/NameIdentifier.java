 ...
 * {@link AlternativeName} ⯈ {@link NameIdentifier}</li>
 ...
 * {@link NameIdentifier}</li>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link Contributor} ⯈ {@link NameIdentifier}</li>
 * <li>{@link Product} ⯈ {@link ContentDetail} ⯈ {@link ContentItem} ⯈ {@link Contributor} ⯈ {@link NameIdentifier}</li>
 * <li>{@link Product} ⯈ {@link PromotionDetail} ⯈ {@link PromotionalEvent} ⯈ {@link Contributor} ⯈
 * {@link NameIdentifier}</li>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link Collection} ⯈ {@link Contributor} ⯈
 * {@link NameIdentifier}</li>
 * <li>{@link Product} ⯈ {@link DescriptiveDetail} ⯈ {@link NameAsSubject} ⯈ {@link NameIdentifier}</li>
...
public class NameIdentifier
    ...
    public void ifExists(Consumer<NameIdentifier> action) {
        if (exists) {
            action.accept(this);
        }
    }
     ...
     * &lt;NameIDType&gt; element indicates a proprietary scheme. Optional and non-repeating.
     * </p>
