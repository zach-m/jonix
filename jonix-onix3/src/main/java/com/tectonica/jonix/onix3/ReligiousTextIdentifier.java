...
/**
 * <h1>Religious text identifier</h1><p>An ONIX code indicating a religious text other than the Bible. Mandatory in each occurrence of the &lt;ReligiousText&gt; composite that does <em>not</em> include a &lt;Bible&gt; composite, and non-repeating.</p><table border='1' cellpadding='3'><tr><td>Format</td><td>Fixed length, two digits</td></tr><tr><td>Codelist</td><td>List 88</td></tr><tr><td>Reference name</td><td><tt>&lt;ReligiousTextIdentifier&gt;</tt></td></tr><tr><td>Short tag</td><td><tt>&lt;b376&gt;</tt></td></tr><tr><td>Cardinality</td><td>0&#8230;1</td></tr></table>
 * <p>&nbsp;</p>
 ...
 * <ul>
 * <li>ONIXMessage ⯈ Product ⯈ DescriptiveDetail ⯈ ReligiousText ⯈ ReligiousTextIdentifier</li>
 * </ul>
 */
public class ReligiousTextIdentifier implements OnixElement<String>, Serializable
{
   ...
   /**
   * Raw Format: Fixed length, two digits<p>
   * (type: List88)
   */
   public String value;
