...
import com.tectonica.jonix.unify.basic.BasicPrice;
import com.tectonica.jonix.unify.basic.BasicProduct;
import com.tectonica.jonix.unify.basic.BasicSalesRights;
import com.tectonica.jonix.unify.basic.BasicSubject;
import com.tectonica.jonix.unify.basic.BasicText;
...
public abstract class BasicColumn implements JonixColumn<BasicProduct> {
    ...
    private static boolean extractProductId(BasicProduct product, String[] columnBuffer,
    ...
    private static boolean extractTitle(BasicProduct product, String[] columnBuffer,
                                        TitleTypes stdType) {
    ...
    private static boolean extractLanguage(BasicProduct product, String[] columnBuffer,
    ...
    private static boolean extractPrices(BasicProduct product, String[] columnBuffer,
    ...
    private static boolean extractContributors(BasicProduct product, String[] columnBuffer,
    ...
    private static boolean extractOtherText(BasicProduct product, String[] columnBuffer,
                                            TextTypes stdType) {
