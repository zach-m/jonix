...
/**
 * Enum that corresponds to Onix's CodeList 83
 * 
 * @author Zach Melamed
 * 
 */
public enum BibleVersions
{
	...
	private BibleVersions(String code)
	{
		this.code = code;
	}

	private static BibleVersions[] values = BibleVersions.values();
	public static BibleVersions fromCode(String code)
	{
		if (code != null && !code.isEmpty())
			for (BibleVersions item : values)
