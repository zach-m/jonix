...
/**
 * Enum that corresponds to Onix's CodeList 27
 * 
 * @author Zach Melamed
 * 
 */
public enum SubjectSchemeIds
{
	/**
	...
	private SubjectSchemeIds(String code)
	{
		this.code = code;
	}

	private static SubjectSchemeIds[] values = SubjectSchemeIds.values();
	public static SubjectSchemeIds fromCode(String code)
	{
		if (code != null && !code.isEmpty())
			for (SubjectSchemeIds item : values)
