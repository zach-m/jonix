...
/**
 * Enum that corresponds to Onix's CodeList 91
 * 
 * @author Zach Melamed
 * 
 */
public enum CountryCodeIso31661s
{
	...
	Korea__Democratic_Peoples_Republic_of("KP"),
	...
	Palestinian_Territory__Occupied("PS"),
	...
	private CountryCodeIso31661s(String code)
	{
		this.code = code;
	}

	private static CountryCodeIso31661s[] values = CountryCodeIso31661s.values();
	public static CountryCodeIso31661s fromCode(String code)
	{
		if (code != null && !code.isEmpty())
			for (CountryCodeIso31661s item : values)
