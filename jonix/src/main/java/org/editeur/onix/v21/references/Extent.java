 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.editeur.org/onix/2.1/reference}ExtentType"/>
 *         &lt;element ref="{http://www.editeur.org/onix/2.1/reference}ExtentValue"/>
 *         &lt;element ref="{http://www.editeur.org/onix/2.1/reference}ExtentUnit"/>
 *       &lt;/sequence>
...
public class Extent {
    ...
    @XmlElement(name = "ExtentValue", required = true)
